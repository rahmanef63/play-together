...
import telurConfig from "../../games/ibu-ibu-telur-gulung/game.config.json" with { type: "json" };
...
export const ibuIbuTelurGulung = `${telurConfig.game.id}@${telurConfig.game.version}`;
