...
void main() {
	...
	`}var pa=class extends zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new es(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new cn(5,5,5),r=new Vt({name:"CubemapFromEquirect",uniforms:oi(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Rt,blending:un});r.uniforms.tEquirect.value=t;let a=new it(s,r),o=t.minFilter;return t.minFilter===Xn&&(t.minFilter=St),new Mr(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){let r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}};function uf(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,g=!1){return h==null?null:g?a(h):r(h)}function r(h){if(h&&h.isTexture){let g=h.mapping;if(g===br||g===Er)if(e.has(h)){let x=e.get(h).texture;return o(x,h.mapping)}else{let x=h.image;if(x&&x.height>0){let M=new pa(x.height);return M.fromEquirectangularTexture(i,h),e.set(h,M),h.addEventListener("dispose",l),o(M.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){let g=h.mapping,x=g===br||g===Er,M=g===Wn||g===ai;if(x||M){let m=t.get(h),u=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==u)return n===null&&(n=new fa(i)),m=x?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{let w=h.image;return x&&w&&w.height>0||M&&w&&c(w)?(n===null&&(n=new fa(i)),m=x?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",d),m.texture):null}}}return h}function o(h,g){return g===br?h.mapping=Wn:g===Er&&(h.mapping=ai),h}function c(h){let g=0,x=6;for(let M=0;M<x;M++)h[M]!==void 0&&g++;return g===x}function l(h){let g=h.target;g.removeEventListener("dispose",l);let x=e.get(g);x!==void 0&&(e.delete(g),x.dispose())}function d(h){let g=h.target;g.removeEventListener("dispose",d);let x=t.get(g);x!==void 0&&(t.delete(g),x.dispose())}function p(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:p}}function df(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let s=t(n);return s===null&&ti("WebGLRenderer: "+n+" extension not supported."),s}}}function ff(i,e,t,n){let s={},r=new WeakMap;function a(p){let h=p.target;h.index!==null&&e.remove(h.index);for(let x in h.attributes)e.remove(h.attributes[x]);h.removeEventListener("dispose",a),delete s[h.id];let g=r.get(h);g&&(e.remove(g),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(p,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function c(p){let h=p.attributes;for(let g in h)e.update(h[g],i.ARRAY_BUFFER)}function l(p){let h=[],g=p.index,x=p.attributes.position,M=0;if(x===void 0)return;if(g!==null){let w=g.array;M=g.version;for(let P=0,y=w.length;P<y;P+=3){let T=w[P+0],E=w[P+1],C=w[P+2];h.push(T,E,E,C,C,T)}}else{let w=x.array;M=x.version;for(let P=0,y=w.length/3-1;P<y;P+=3){let T=P+0,E=P+1,C=P+2;h.push(T,E,E,C,C,T)}}let m=new(x.count>=65535?ji:Qi)(h,1);m.version=M;let u=r.get(p);u&&e.remove(u),r.set(p,m)}function d(p){let h=r.get(p);if(h){let g=p.index;g!==null&&h.version<g.version&&l(p)}else l(p);return r.get(p)}return{get:o,update:c,getWireframeAttribute:d}}function pf(i,e,t){let n;function s(p){n=p}let r,a;function o(p){r=p.type,a=p.bytesPerElement}function c(p,h){i.drawElements(n,h,r,p*a),t.update(h,n,1)}function l(p,h,g){g!==0&&(i.drawElementsInstanced(n,h,r,p*a,g),t.update(h,n,g))}function d(p,h,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,p,0,g);let M=0;for(let m=0;m<g;m++)M+=h[m];t.update(M,n,1)}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=d}function mf(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:Ce("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function gf(i,e,t){let n=new WeakMap,s=new tt;function r(a,o,c){let l=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=d!==void 0?d.length:0,h=n.get(o);if(h===void 0||h.count!==p){let b=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",b)};h!==void 0&&h.texture.dispose();let g=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,M=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],u=o.morphAttributes.normal||[],w=o.morphAttributes.color||[],P=0;g===!0&&(P=1),x===!0&&(P=2),M===!0&&(P=3);let y=o.attributes.position.count*P,T=1;y>e.maxTextureSize&&(T=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);let E=new Float32Array(y*T*4*p),C=new Zi(E,y,T,p);C.type=Qt,C.needsUpdate=!0;let _=P*4;for(let R=0;R<p;R++){let A=m[R],I=u[R],O=w[R],H=y*T*4*R;for(let B=0;B<A.count;B++){let W=B*_;g===!0&&(s.fromBufferAttribute(A,B),E[H+W+0]=s.x,E[H+W+1]=s.y,E[H+W+2]=s.z,E[H+W+3]=0),x===!0&&(s.fromBufferAttribute(I,B),E[H+W+4]=s.x,E[H+W+5]=s.y,E[H+W+6]=s.z,E[H+W+7]=0),M===!0&&(s.fromBufferAttribute(O,B),E[H+W+8]=s.x,E[H+W+9]=s.y,E[H+W+10]=s.z,E[H+W+11]=O.itemSize===4?s.w:1)}}h={count:p,texture:C,size:new ze(y,T)},n.set(o,h),o.addEventListener("dispose",b)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let M=0;M<l.length;M++)g+=l[M];let x=o.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",x),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function _f(i,e,t,n,s){let r=new WeakMap;function a(l){let d=s.render.frame,p=l.geometry,h=e.get(l,p);if(r.get(h)!==d&&(e.update(h),r.set(h,d)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),r.get(l)!==d&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,d))),l.isSkinnedMesh){let g=l.skeleton;r.get(g)!==d&&(g.update(),r.set(g,d))}return h}function o(){r=new WeakMap}function c(l){let d=l.target;d.removeEventListener("dispose",c),n.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:o}}var xf={[ro]:"LINEAR_TONE_MAPPING",[ao]:"REINHARD_TONE_MAPPING",[oo]:"CINEON_TONE_MAPPING",[lo]:"ACES_FILMIC_TONE_MAPPING",[ho]:"AGX_TONE_MAPPING",[uo]:"NEUTRAL_TONE_MAPPING",[co]:"CUSTOM_TONE_MAPPING"};function vf(i,e,t,n,s,r){let a=new zt(e,t,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,depthTexture:s?new En(e,t):void 0}),o=new zt(e,t,{type:dn,depthBuffer:!1,stencilBuffer:!1}),c=new Wt;c.setAttribute("position",new vt([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new vt([0,2,0,0,2,0],2));let l=new lr({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+u);let P=w+m+a,y=w+u+o,T=fc(s,s.VERTEX_SHADER,P),E=fc(s,s.FRAGMENT_SHADER,y);s.attachShader(M,T),s.attachShader(M,E),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function C(A){if(i.debug.checkShaderErrors){let I=s.getProgramInfoLog(M)||"",O=s.getShaderInfoLog(T)||"",H=s.getShaderInfoLog(E)||"",B=I.trim(),W=O.trim(),X=H.trim(),K=!0,j=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,T,E);else{let he=mc(s,T,"vertex"),pe=mc(s,E,"fragment");Ce("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
Program Info Log: `+B+`
`+he+`
`+pe)}else B!==""?we("WebGLProgram: Program Info Log:",B):(W===""||X==="")&&(j=!1);j&&(A.diagnostics={runnable:K,programLog:B,vertexShader:{log:W,prefix:m},fragmentShader:{log:X,prefix:u}})}s.deleteShader(T),s.deleteShader(E),_=new Oi(s,M),b=_p(s,M)}let _;this.getUniforms=function(){return _===void 0&&C(this),_};let b;this.getAttributes=function(){return b===void 0&&C(this),b};let R=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return R===!1&&(R=s.getProgramParameter(M,op)),R},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=lp++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=T,this.fragmentShader=E,this}var Dp=0,Bo=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,n){let s=this._getShaderCacheForMaterial(e);return s.has(t)===!1&&(s.add(t),t.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(e){let t=this.materialCache.get(e);for(let n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){let t=this.shaderCache,n=t.get(e);return n===void 0&&(n=new zo(e),t.set(e,n)),n}},zo=class{constructor(e){this.id=Dp++,this.code=e,this.usedTimes=0}};function Np(i){return i===Yn||i===ps||i===ms}function Up(i,e,t,n,s,r){let a=new Ji,o=new Bo,c=new Set,l=[],d=new Map,p=n.logarithmicDepthBuffer,h=n.precision,g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(_){return c.add(_),_===0?"uv":`uv${_}`}function M(_,b,R,A,I,O){let H=A.fog,B=I.geometry,W=_.isMeshStandardMaterial||_.isMeshLambertMaterial||_.isMeshPhongMaterial?A.environment:null,X=_.isMeshStandardMaterial||_.isMeshLambertMaterial&&!_.envMap||_.isMeshPhongMaterial&&!_.envMap,K=e.get(_.envMap||W,X),j=K&&K.mapping===ls?K.image.height:null,he=g[_.type];_.precision!==null&&(h=n.getMaxPrecision(_.precision),h!==_.precision&&we("WebGLProgram.getParameters:",_.precision,"not supported, using",h,"instead."));let pe=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,_e=pe!==void 0?pe.length:0,He=0;B.morphAttributes.position!==void 0&&(He=1),B.morphAttributes.normal!==void 0&&(He=2),B.morphAttributes.color!==void 0&&(He=3);let st,We,$,ie;if(he){let xe=pn[he];st=xe.vertexShader,We=xe.fragmentShader}else{st=_.vertexShader,We=_.fragmentShader;let xe=o.getVertexShaderStage(_),at=o.getFragmentShaderStage(_);o.update(_,xe,at),$=xe.id,ie=at.id}let ee=i.getRenderTarget(),Re=i.state.buffers.depth.getReversed(),Pe=I.isInstancedMesh===!0,Te=I.isBatchedMesh===!0,lt=!!_.map,Oe=!!_.matcap,Je=!!K,Xe=!!_.aoMap,ke=!!_.lightMap,ut=!!_.bumpMap&&_.wireframe===!1,pt=!!_.normalMap,_t=!!_.displacementMap,Mt=!!_.emissiveMap,rt=!!_.metalnessMap,dt=!!_.roughnessMap,D=_.anisotropy>0,It=_.clearcoat>0,Ye=_.dispersion>0,S=_.iridescence>0,f=_.sheen>0,U=_.transmission>0,k=D&&!!_.anisotropyMap,q=It&&!!_.clearcoatMap,te=It&&!!_.clearcoatNormalMap,se=It&&!!_.clearcoatRoughnessMap,Y=S&&!!_.iridescenceMap,J=S&&!!_.iridescenceThicknessMap,re=f&&!!_.sheenColorMap,Me=f&&!!_.sheenRoughnessMap,le=!!_.specularMap,ae=!!_.specularColorMap,Ee=!!_.specularIntensityMap,Ae=U&&!!_.transmissionMap,Le=U&&!!_.thicknessMap,L=!!_.gradientMap,ne=!!_.alphaMap,Z=_.alphaTest>0,oe=!!_.alphaHash,fe=!!_.extensions,Q=$t;_.toneMapped&&(ee===null||ee.isXRRenderTarget===!0)&&(Q=i.toneMapping);let ye={shaderID:he,shaderType:_.type,shaderName:_.name,vertexShader:st,fragmentShader:We,defines:_.defines,customVertexShaderID:$,customFragmentShaderID:ie,isRawShaderMaterial:_.isRawShaderMaterial===!0,glslVersion:_.glslVersion,precision:h,batching:Te,batchingColor:Te&&I._colorsTexture!==null,instancing:Pe,instancingColor:Pe&&I.instanceColor!==null,instancingMorph:Pe&&I.morphTexture!==null,outputColorSpace:ee===null?i.outputColorSpace:ee.isXRRenderTarget===!0?ee.texture.colorSpace:Be.workingColorSpace,alphaToCoverage:!!_.alphaToCoverage,map:lt,matcap:Oe,envMap:Je,envMapMode:Je&&K.mapping,envMapCubeUVHeight:j,aoMap:Xe,lightMap:ke,bumpMap:ut,normalMap:pt,displacementMap:_t,emissiveMap:Mt,normalMapObjectSpace:pt&&_.normalMapType===Gl,normalMapTangentSpace:pt&&_.normalMapType===la,packedNormalMap:pt&&_.normalMapType===la&&Np(_.normalMap.format),metalnessMap:rt,roughnessMap:dt,anisotropy:D,anisotropyMap:k,clearcoat:It,clearcoatMap:q,clearcoatNormalMap:te,clearcoatRoughnessMap:se,dispersion:Ye,iridescence:S,iridescenceMap:Y,iridescenceThicknessMap:J,sheen:f,sheenColorMap:re,sheenRoughnessMap:Me,specularMap:le,specularColorMap:ae,specularIntensityMap:Ee,transmission:U,transmissionMap:Ae,thicknessMap:Le,gradientMap:L,opaque:_.transparent===!1&&_.blending===ni&&_.alphaToCoverage===!1,alphaMap:ne,alphaTest:Z,alphaHash:oe,combine:_.combine,mapUv:lt&&x(_.map.channel),aoMapUv:Xe&&x(_.aoMap.channel),lightMapUv:ke&&x(_.lightMap.channel),bumpMapUv:ut&&x(_.bumpMap.channel),normalMapUv:pt&&x(_.normalMap.channel),displacementMapUv:_t&&x(_.displacementMap.channel),emissiveMapUv:Mt&&x(_.emissiveMap.channel),metalnessMapUv:rt&&x(_.metalnessMap.channel),roughnessMapUv:dt&&x(_.roughnessMap.channel),anisotropyMapUv:k&&x(_.anisotropyMap.channel),clearcoatMapUv:q&&x(_.clearcoatMap.channel),clearcoatNormalMapUv:te&&x(_.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:se&&x(_.clearcoatRoughnessMap.channel),iridescenceMapUv:Y&&x(_.iridescenceMap.channel),iridescenceThicknessMapUv:J&&x(_.iridescenceThicknessMap.channel),sheenColorMapUv:re&&x(_.sheenColorMap.channel),sheenRoughnessMapUv:Me&&x(_.sheenRoughnessMap.channel),specularMapUv:le&&x(_.specularMap.channel),specularColorMapUv:ae&&x(_.specularColorMap.channel),specularIntensityMapUv:Ee&&x(_.specularIntensityMap.channel),transmissionMapUv:Ae&&x(_.transmissionMap.channel),thicknessMapUv:Le&&x(_.thicknessMap.channel),alphaMapUv:ne&&x(_.alphaMap.channel),vertexTangents:!!B.attributes.tangent&&(pt||D),vertexNormals:!!B.attributes.normal,vertexColors:_.vertexColors,vertexAlphas:_.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,pointsUvs:I.isPoints===!0&&!!B.attributes.uv&&(lt||ne),fog:!!H,useFog:_.fog===!0,fogExp2:!!H&&H.isFogExp2,flatShading:_.wireframe===!1&&(_.flatShading===!0||B.attributes.normal===void 0&&pt===!1&&(_.isMeshLambertMaterial||_.isMeshPhongMaterial||_.isMeshStandardMaterial||_.isMeshPhysicalMaterial)),sizeAttenuation:_.sizeAttenuation===!0,logarithmicDepthBuffer:p,reversedDepthBuffer:Re,skinning:I.isSkinnedMesh===!0,hasPositionAttribute:B.attributes.position!==void 0,morphTargets:B.morphAttributes.position!==void 0,morphNormals:B.morphAttributes.normal!==void 0,morphColors:B.morphAttributes.color!==void 0,morphTargetsCount:_e,morphTextureStride:He,numDirLights:b.directional.length,numPointLights:b.point.length,numSpotLights:b.spot.length,numSpotLightMaps:b.spotLightMap.length,numRectAreaLights:b.rectArea.length,numHemiLights:b.hemi.length,numDirLightShadows:b.directionalShadowMap.length,numPointLightShadows:b.pointShadowMap.length,numSpotLightShadows:b.spotShadowMap.length,numSpotLightShadowsWithMaps:b.numSpotLightShadowsWithMaps,numLightProbes:b.numLightProbes,numLightProbeGrids:O.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:_.dithering,shadowMapEnabled:i.shadowMap.enabled&&R.length>0,shadowMapType:i.shadowMap.type,toneMapping:Q,decodeVideoTexture:lt&&_.map.isVideoTexture===!0&&Be.getTransfer(_.map.colorSpace)===qe,decodeVideoTextureEmissive:Mt&&_.emissiveMap.isVideoTexture===!0&&Be.getTransfer(_.emissiveMap.colorSpace)===qe,premultipliedAlpha:_.premultipliedAlpha,doubleSided:_.side===hn,flipSided:_.side===Rt,useDepthPacking:_.depthPacking>=0,depthPacking:_.depthPacking||0,index0AttributeName:_.index0AttributeName,extensionClipCullDistance:fe&&_.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(fe&&_.extensions.multiDraw===!0||Te)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:_.customProgramCacheKey()};return ye.vertexUv1s=c.has(1),ye.vertexUv2s=c.has(2),ye.vertexUv3s=c.has(3),c.clear(),ye}function m(_){let b=[];if(_.shaderID?b.push(_.shaderID):(b.push(_.customVertexShaderID),b.push(_.customFragmentShaderID)),_.defines!==void 0)for(let R in _.defines)b.push(R),b.push(_.defines[R]);return _.isRawShaderMaterial===!1&&(u(b,_),w(b,_),b.push(i.outputColorSpace)),b.push(_.customProgramCacheKey),b.join()}function u(_,b){_.push(b.precision),_.push(b.outputColorSpace),_.push(b.envMapMode),_.push(b.envMapCubeUVHeight),_.push(b.mapUv),_.push(b.alphaMapUv),_.push(b.lightMapUv),_.push(b.aoMapUv),_.push(b.bumpMapUv),_.push(b.normalMapUv),_.push(b.displacementMapUv),_.push(b.emissiveMapUv),_.push(b.metalnessMapUv),_.push(b.roughnessMapUv),_.push(b.anisotropyMapUv),_.push(b.clearcoatMapUv),_.push(b.clearcoatNormalMapUv),_.push(b.clearcoatRoughnessMapUv),_.push(b.iridescenceMapUv),_.push(b.iridescenceThicknessMapUv),_.push(b.sheenColorMapUv),_.push(b.sheenRoughnessMapUv),_.push(b.specularMapUv),_.push(b.specularColorMapUv),_.push(b.specularIntensityMapUv),_.push(b.transmissionMapUv),_.push(b.thicknessMapUv),_.push(b.combine),_.push(b.fogExp2),_.push(b.sizeAttenuation),_.push(b.morphTargetsCount),_.push(b.morphAttributeCount),_.push(b.numDirLights),_.push(b.numPointLights),_.push(b.numSpotLights),_.push(b.numSpotLightMaps),_.push(b.numHemiLights),_.push(b.numRectAreaLights),_.push(b.numDirLightShadows),_.push(b.numPointLightShadows),_.push(b.numSpotLightShadows),_.push(b.numSpotLightShadowsWithMaps),_.push(b.numLightProbes),_.push(b.shadowMapType),_.push(b.toneMapping),_.push(b.numClippingPlanes),_.push(b.numClipIntersection),_.push(b.depthPacking)}function w(_,b){a.disableAll(),b.instancing&&a.enable(0),b.instancingColor&&a.enable(1),b.instancingMorph&&a.enable(2),b.matcap&&a.enable(3),b.envMap&&a.enable(4),b.normalMapObjectSpace&&a.enable(5),b.normalMapTangentSpace&&a.enable(6),b.clearcoat&&a.enable(7),b.iridescence&&a.enable(8),b.alphaTest&&a.enable(9),b.vertexColors&&a.enable(10),b.vertexAlphas&&a.enable(11),b.vertexUv1s&&a.enable(12),b.vertexUv2s&&a.enable(13),b.vertexUv3s&&a.enable(14),b.vertexTangents&&a.enable(15),b.anisotropy&&a.enable(16),b.alphaHash&&a.enable(17),b.batching&&a.enable(18),b.dispersion&&a.enable(19),b.batchingColor&&a.enable(20),b.gradientMap&&a.enable(21),b.packedNormalMap&&a.enable(22),b.vertexNormals&&a.enable(23),_.push(a.mask),a.disableAll(),b.fog&&a.enable(0),b.useFog&&a.enable(1),b.flatShading&&a.enable(2),b.logarithmicDepthBuffer&&a.enable(3),b.reversedDepthBuffer&&a.enable(4),b.skinning&&a.enable(5),b.morphTargets&&a.enable(6),b.morphNormals&&a.enable(7),b.morphColors&&a.enable(8),b.premultipliedAlpha&&a.enable(9),b.shadowMapEnabled&&a.enable(10),b.doubleSided&&a.enable(11),b.flipSided&&a.enable(12),b.useDepthPacking&&a.enable(13),b.dithering&&a.enable(14),b.transmission&&a.enable(15),b.sheen&&a.enable(16),b.opaque&&a.enable(17),b.pointsUvs&&a.enable(18),b.decodeVideoTexture&&a.enable(19),b.decodeVideoTextureEmissive&&a.enable(20),b.alphaToCoverage&&a.enable(21),b.numLightProbeGrids>0&&a.enable(22),b.hasPositionAttribute&&a.enable(23),_.push(a.mask)}function P(_){let b=g[_.type],R;if(b){let A=pn[b];R=ec.clone(A.uniforms)}else R=_.uniforms;return R}function y(_,b){let R=d.get(b);return R!==void 0?++R.usedTimes:(R=new Lp(i,b,_,s),l.push(R),d.set(b,R)),R}function T(_){if(--_.usedTimes===0){let b=l.indexOf(_);l[b]=l[l.length-1],l.pop(),d.delete(_.cacheKey),_.destroy()}}function E(_){o.remove(_)}function C(){o.dispose()}return{getParameters:M,getProgramCacheKey:m,getUniforms:P,acquireProgram:y,releaseProgram:T,releaseShaderCache:E,programs:l,dispose:C}}function Fp(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,c){i.get(a)[o]=c}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function Op(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function yc(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Mc(){let i=[],e=0,t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(h){let g=0;return h.isInstancedMesh&&(g+=2),h.isSkinnedMesh&&(g+=1),g}function o(h,g,x,M,m,u){let w=i[e];return w===void 0?(w={id:h.id,object:h,geometry:g,material:x,materialVariant:a(h),groupOrder:M,renderOrder:h.renderOrder,z:m,group:u},i[e]=w):(w.id=h.id,w.object=h,w.geometry=g,w.material=x,w.materialVariant=a(h),w.groupOrder=M,w.renderOrder=h.renderOrder,w.z=m,w.group=u),e++,w}function c(h,g,x,M,m,u){let w=o(h,g,x,M,m,u);x.transmission>0?n.push(w):x.transparent===!0?s.push(w):t.push(w)}function l(h,g,x,M,m,u){let w=o(h,g,x,M,m,u);x.transmission>0?n.unshift(w):x.transparent===!0?s.unshift(w):t.unshift(w)}function d(h,g,x){t.length>1&&t.sort(h||Op),n.length>1&&n.sort(g||yc),s.length>1&&s.sort(g||yc),x&&(t.reverse(),n.reverse(),s.reverse())}function p(){for(let h=e,g=i.length;h<g;h++){let x=i[h];if(x.id===null)break;x.id=null,x.object=null,x.geometry=null,x.material=null,x.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:c,unshift:l,finish:p,sort:d}}function Bp(){let i=new WeakMap;function e(n,s){let r=i.get(n),a;return r===void 0?(a=new Mc,i.set(n,[a])):s>=r.length?(a=new Mc,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function zp(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new F,color:new Fe};break;case"SpotLight":t={position:new F,direction:new F,color:new Fe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new F,color:new Fe,distance:0,decay:0};break;case"HemisphereLight":t={direction:new F,skyColor:new Fe,groundColor:new Fe};break;case"RectAreaLight":t={color:new Fe,position:new F,halfWidth:new F,halfHeight:new F};break}return i[e.id]=t,t}}}function Vp(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ze};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ze};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ze,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}var kp=0;function Gp(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Hp(i){let e=new zp,t=Vp(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new F);let s=new F,r=new nt,a=new nt;function o(l){let d=0,p=0,h=0;for(let b=0;b<9;b++)n.probe[b].set(0,0,0);let g=0,x=0,M=0,m=0,u=0,w=0,P=0,y=0,T=0,E=0,C=0;l.sort(Gp);for(let b=0,R=l.length;b<R;b++){let A=l[b],I=A.color,O=A.intensity,H=A.distance,B=null;if(A.shadow&&A.shadow.map&&(A.shadow.map.texture.format===Yn?B=A.shadow.map.texture:B=A.shadow.map.depthTexture||A.shadow.map.texture),A.isAmbientLight)d+=I.r*O,p+=I.g*O,h+=I.b*O;else if(A.isLightProbe){for(let W=0;W<9;W++)n.probe[W].addScaledVector(A.sh.coefficients[W],O);C++}else if(A.isDirectionalLight){let W=e.get(A);if(W.color.copy(A.color).multiplyScalar(A.intensity),A.castShadow){let X=A.shadow,K=t.get(A);K.shadowIntensity=X.intensity,K.shadowBias=X.bias,K.shadowNormalBias=X.normalBias,K.shadowRadius=X.radius,K.shadowMapSize=X.mapSize,n.directionalShadow[g]=K,n.directionalShadowMap[g]=B,n.directionalShadowMatrix[g]=A.shadow.matrix,w++}n.directional[g]=W,g++}else if(A.isSpotLight){let W=e.get(A);W.position.setFromMatrixPosition(A.matrixWorld),W.color.copy(I).multiplyScalar(O),W.distance=H,W.coneCos=Math.cos(A.angle),W.penumbraCos=Math.cos(A.angle*(1-A.penumbra)),W.decay=A.decay,n.spot[M]=W;let X=A.shadow;if(A.map&&(n.spotLightMap[T]=A.map,T++,X.updateMatrices(A),A.castShadow&&E++),n.spotLightMatrix[M]=X.matrix,A.castShadow){let K=t.get(A);K.shadowIntensity=X.intensity,K.shadowBias=X.bias,K.shadowNormalBias=X.normalBias,K.shadowRadius=X.radius,K.shadowMapSize=X.mapSize,n.spotShadow[M]=K,n.spotShadowMap[M]=B,y++}M++}else if(A.isRectAreaLight){let W=e.get(A);W.color.copy(I).multiplyScalar(O),W.halfWidth.set(A.width*.5,0,0),W.halfHeight.set(0,A.height*.5,0),n.rectArea[m]=W,m++}else if(A.isPointLight){let W=e.get(A);if(W.color.copy(A.color).multiplyScalar(A.intensity),W.distance=A.distance,W.decay=A.decay,A.castShadow){let X=A.shadow,K=t.get(A);K.shadowIntensity=X.intensity,K.shadowBias=X.bias,K.shadowNormalBias=X.normalBias,K.shadowRadius=X.radius,K.shadowMapSize=X.mapSize,K.shadowCameraNear=X.camera.near,K.shadowCameraFar=X.camera.far,n.pointShadow[x]=K,n.pointShadowMap[x]=B,n.pointShadowMatrix[x]=A.shadow.matrix,P++}n.point[x]=W,x++}else if(A.isHemisphereLight){let W=e.get(A);W.skyColor.copy(A.color).multiplyScalar(O),W.groundColor.copy(A.groundColor).multiplyScalar(O),n.hemi[u]=W,u++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ce.LTC_FLOAT_1,n.rectAreaLTC2=ce.LTC_FLOAT_2):(n.rectAreaLTC1=ce.LTC_HALF_1,n.rectAreaLTC2=ce.LTC_HALF_2)),n.ambient[0]=d,n.ambient[1]=p,n.ambient[2]=h;let _=n.hash;(_.directionalLength!==g||_.pointLength!==x||_.spotLength!==M||_.rectAreaLength!==m||_.hemiLength!==u||_.numDirectionalShadows!==w||_.numPointShadows!==P||_.numSpotShadows!==y||_.numSpotMaps!==T||_.numLightProbes!==C)&&(n.directional.length=g,n.spot.length=M,n.rectArea.length=m,n.point.length=x,n.hemi.length=u,n.directionalShadow.length=w,n.directionalShadowMap.length=w,n.pointShadow.length=P,n.pointShadowMap.length=P,n.spotShadow.length=y,n.spotShadowMap.length=y,n.directionalShadowMatrix.length=w,n.pointShadowMatrix.length=P,n.spotLightMatrix.length=y+T-E,n.spotLightMap.length=T,n.numSpotLightShadowsWithMaps=E,n.numLightProbes=C,_.directionalLength=g,_.pointLength=x,_.spotLength=M,_.rectAreaLength=m,_.hemiLength=u,_.numDirectionalShadows=w,_.numPointShadows=P,_.numSpotShadows=y,_.numSpotMaps=T,_.numLightProbes=C,n.version=kp++)}function c(l,d){let p=0,h=0,g=0,x=0,M=0,m=d.matrixWorldInverse;for(let u=0,w=l.length;u<w;u++){let P=l[u];if(P.isDirectionalLight){let y=n.directional[p];y.direction.setFromMatrixPosition(P.matrixWorld),s.setFromMatrixPosition(P.target.matrixWorld),y.direction.sub(s),y.direction.transformDirection(m),p++}else if(P.isSpotLight){let y=n.spot[g];y.position.setFromMatrixPosition(P.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(P.matrixWorld),s.setFromMatrixPosition(P.target.matrixWorld),y.direction.sub(s),y.direction.transformDirection(m),g++}else if(P.isRectAreaLight){let y=n.rectArea[x];y.position.setFromMatrixPosition(P.matrixWorld),y.position.applyMatrix4(m),a.identity(),r.copy(P.matrixWorld),r.premultiply(m),a.extractRotation(r),y.halfWidth.set(P.width*.5,0,0),y.halfHeight.set(0,P.height*.5,0),y.halfWidth.applyMatrix4(a),y.halfHeight.applyMatrix4(a),x++}else if(P.isPointLight){let y=n.point[h];y.position.setFromMatrixPosition(P.matrixWorld),y.position.applyMatrix4(m),h++}else if(P.isHemisphereLight){let y=n.hemi[M];y.direction.setFromMatrixPosition(P.matrixWorld),y.direction.transformDirection(m),M++}}}return{setup:o,setupView:c,state:n}}function Sc(i){let e=new Hp(i),t=[],n=[],s=[];function r(h){p.camera=h,t.length=0,n.length=0,s.length=0}function a(h){t.push(h)}function o(h){n.push(h)}function c(h){s.push(h)}function l(){e.setup(t)}function d(h){e.setupView(t,h)}let p={lightsArray:t,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:p,setupLights:l,setupLightsView:d,pushLight:a,pushShadow:o,pushLightProbeGrid:c}}function Wp(i){let e=new WeakMap;function t(s,r=0){let a=e.get(s),o;return a===void 0?(o=new Sc(i),e.set(s,[o])):r>=a.length?(o=new Sc(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}var Xp=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,Yp=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],Zp=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],bc=new nt,xs=new F,Lo=new F;function Jp(i,e,t){let n=new Ri,s=new ze,r=new ze,a=new tt,o=new cr,c=new hr,l={},d=t.maxTextureSize,p={[Sn]:Rt,[Rt]:Sn,[hn]:hn},h=new Vt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ze},radius:{value:4}},vertexShader:Xp,fragmentShader:qp}),g=h.clone();g.defines.HORIZONTAL_PASS=1;let x=new Wt;x.setAttribute("position",new Bt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let M=new it(x,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=os;let u=this.type;this.render=function(E,C,_){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;this.type===vl&&(we("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=os);let b=i.getRenderTarget(),R=i.getActiveCubeFace(),A=i.getActiveMipmapLevel(),I=i.state;I.setBlending(un),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);let O=u!==this.type;O&&C.traverse(function(H){H.material&&(Array.isArray(H.material)?H.material.forEach(B=>B.needsUpdate=!0):H.material.needsUpdate=!0)});for(let H=0,B=E.length;H<B;H++){let W=E[H],X=W.shadow;if(X===void 0){we("WebGLShadowMap:",W,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;s.copy(X.mapSize);let K=X.getFrameExtents();s.multiply(K),r.copy(X.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/K.x),s.x=r.x*K.x,X.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/K.y),s.y=r.y*K.y,X.mapSize.y=r.y));let j=i.state.buffers.depth.getReversed();if(X.camera._reversedDepth=j,X.map===null||O===!0){if(X.map!==null&&(X.map.depthTexture!==null&&(X.map.depthTexture.dispose(),X.map.depthTexture=null),X.map.dispose()),this.type===Di){if(W.isPointLight){we("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}X.map=new zt(s.x,s.y,{format:Yn,type:dn,minFilter:St,magFilter:St,generateMipmaps:!1}),X.map.texture.name=W.name+".shadowMap",X.map.depthTexture=new En(s.x,s.y,Qt),X.map.depthTexture.name=W.name+".shadowMapDepth",X.map.depthTexture.format=an,X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=yt,X.map.depthTexture.magFilter=yt}else W.isPointLight?(X.map=new pa(s.x),X.map.depthTexture=new or(s.x,Kt)):(X.map=new zt(s.x,s.y),X.map.depthTexture=new En(s.x,s.y,Kt)),X.map.depthTexture.name=W.name+".shadowMap",X.map.depthTexture.format=an,this.type===os?(X.map.depthTexture.compareFunction=j?ha:ca,X.map.depthTexture.minFilter=St,X.map.depthTexture.magFilter=St):(X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=yt,X.map.depthTexture.magFilter=yt);X.camera.updateProjectionMatrix()}let he=X.map.isWebGLCubeRenderTarget?6:1;for(let pe=0;pe<he;pe++){if(X.map.isWebGLCubeRenderTarget)i.setRenderTarget(X.map,pe),i.clear();else{pe===0&&(i.setRenderTarget(X.map),i.clear());let _e=X.getViewport(pe);a.set(r.x*_e.x,r.y*_e.y,r.x*_e.z,r.y*_e.w),I.viewport(a)}if(W.isPointLight){let _e=X.camera,He=X.matrix,st=W.distance||_e.far;st!==_e.far&&(_e.far=st,_e.updateProjectionMatrix()),xs.setFromMatrixPosition(W.matrixWorld),_e.position.copy(xs),Lo.copy(_e.position),Lo.add(Yp[pe]),_e.up.copy(Zp[pe]),_e.lookAt(Lo),_e.updateMatrixWorld(),He.makeTranslation(-xs.x,-xs.y,-xs.z),bc.multiplyMatrices(_e.projectionMatrix,_e.matrixWorldInverse),X._frustum.setFromProjectionMatrix(bc,_e.coordinateSystem,_e.reversedDepth)}else X.updateMatrices(W);n=X.getFrustum(),y(C,_,X.camera,W,this.type)}X.isPointLightShadow!==!0&&this.type===Di&&w(X,_),X.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(b,R,A)};function w(E,C){let _=e.update(M);h.defines.VSM_SAMPLES!==E.blurSamples&&(h.defines.VSM_SAMPLES=E.blurSamples,g.defines.VSM_SAMPLES=E.blurSamples,h.needsUpdate=!0,g.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new zt(s.x,s.y,{format:Yn,type:dn})),h.uniforms.shadow_pass.value=E.map.depthTexture,h.uniforms.resolution.value=E.mapSize,h.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(C,null,_,h,M,null),g.uniforms.shadow_pass.value=E.mapPass.texture,g.uniforms.resolution.value=E.mapSize,g.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(C,null,_,g,M,null)}function P(E,C,_,b){let R=null,A=_.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(A!==void 0)R=A;else if(R=_.isPointLight===!0?c:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let I=R.uuid,O=C.uuid,H=l[I];H===void 0&&(H={},l[I]=H);let B=H[O];B===void 0&&(B=R.clone(),H[O]=B,C.addEventListener("dispose",T)),R=B}if(R.visible=C.visible,R.wireframe=C.wireframe,b===Di?R.side=C.shadowSide!==null?C.shadowSide:C.side:R.side=C.shadowSide!==null?C.shadowSide:p[C.side],R.alphaMap=C.alphaMap,R.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,R.map=C.map,R.clipShadows=C.clipShadows,R.clippingPlanes=C.clippingPlanes,R.clipIntersection=C.clipIntersection,R.displacementMap=C.displacementMap,R.displacementScale=C.displacementScale,R.displacementBias=C.displacementBias,R.wireframeLinewidth=C.wireframeLinewidth,R.linewidth=C.linewidth,_.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let I=i.properties.get(R);I.light=_}return R}function y(E,C,_,b,R){if(E.visible===!1)return;if(E.layers.test(C.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&R===Di)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,E.matrixWorld);let O=e.update(E),H=E.material;if(Array.isArray(H)){let B=O.groups;for(let W=0,X=B.length;W<X;W++){let K=B[W],j=H[K.materialIndex];if(j&&j.visible){let he=P(E,j,b,R);E.onBeforeShadow(i,E,C,_,O,he,K),i.renderBufferDirect(_,null,O,he,E,K),E.onAfterShadow(i,E,C,_,O,he,K)}}}else if(H.visible){let B=P(E,H,b,R);E.onBeforeShadow(i,E,C,_,O,B,null),i.renderBufferDirect(_,null,O,B,E,null),E.onAfterShadow(i,E,C,_,O,B,null)}}let I=E.children;for(let O=0,H=I.length;O<H;O++)y(I[O],C,_,b,R)}function T(E){E.target.removeEventListener("dispose",T);for(let _ in l){let b=l[_],R=E.target.uuid;R in b&&(b[R].dispose(),delete b[R])}}}function $p(i,e){function t(){let L=!1,ne=new tt,Z=null,oe=new tt(0,0,0,0);return{setMask:function(fe){Z!==fe&&!L&&(i.colorMask(fe,fe,fe,fe),Z=fe)},setLocked:function(fe){L=fe},setClear:function(fe,Q,ye,xe,at){at===!0&&(fe*=xe,Q*=xe,ye*=xe),ne.set(fe,Q,ye,xe),oe.equals(ne)===!1&&(i.clearColor(fe,Q,ye,xe),oe.copy(ne))},reset:function(){L=!1,Z=null,oe.set(-1,0,0,0)}}}function n(){let L=!1,ne=!1,Z=null,oe=null,fe=null;return{setReversed:function(Q){if(ne!==Q){let ye=e.get("EXT_clip_control");Q?ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.ZERO_TO_ONE_EXT):ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.NEGATIVE_ONE_TO_ONE_EXT),ne=Q;let xe=fe;fe=null,this.setClear(xe)}},getReversed:function(){return ne},setTest:function(Q){Q?ee(i.DEPTH_TEST):Re(i.DEPTH_TEST)},setMask:function(Q){Z!==Q&&!L&&(i.depthMask(Q),Z=Q)},setFunc:function(Q){if(ne&&(Q=Ql[Q]),oe!==Q){switch(Q){case Xs:i.depthFunc(i.NEVER);break;case qs:i.depthFunc(i.ALWAYS);break;case Ys:i.depthFunc(i.LESS);break;case ii:i.depthFunc(i.LEQUAL);break;case Zs:i.depthFunc(i.EQUAL);break;case Js:i.depthFunc(i.GEQUAL);break;case $s:i.depthFunc(i.GREATER);break;case Ks:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}oe=Q}},setLocked:function(Q){L=Q},setClear:function(Q){fe!==Q&&(fe=Q,ne&&(Q=1-Q),i.clearDepth(Q))},reset:function(){L=!1,Z=null,oe=null,fe=null,ne=!1}}}function s(){let L=!1,ne=null,Z=null,oe=null,fe=null,Q=null,ye=null,xe=null,at=null;return{setTest:function(Qe){L||(Qe?ee(i.STENCIL_TEST):Re(i.STENCIL_TEST))},setMask:function(Qe){ne!==Qe&&!L&&(i.stencilMask(Qe),ne=Qe)},setFunc:function(Qe,jt,en){(Z!==Qe||oe!==jt||fe!==en)&&(i.stencilFunc(Qe,jt,en),Z=Qe,oe=jt,fe=en)},setOp:function(Qe,jt,en){(Q!==Qe||ye!==jt||xe!==en)&&(i.stencilOp(Qe,jt,en),Q=Qe,ye=jt,xe=en)},setLocked:function(Qe){L=Qe},setClear:function(Qe){at!==Qe&&(i.clearStencil(Qe),at=Qe)},reset:function(){L=!1,ne=null,Z=null,oe=null,fe=null,Q=null,ye=null,xe=null,at=null}}}let r=new t,a=new n,o=new s,c=new WeakMap,l=new WeakMap,d={},p={},h={},g=new WeakMap,x=[],M=null,m=!1,u=null,w=null,P=null,y=null,T=null,E=null,C=null,_=new Fe(0,0,0),b=0,R=!1,A=null,I=null,O=null,H=null,B=null,W=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),X=!1,K=0,j=i.getParameter(i.VERSION);j.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(j)[1]),X=K>=1):j.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),X=K>=2);let he=null,pe={},_e=i.getParameter(i.SCISSOR_BOX),He=i.getParameter(i.VIEWPORT),st=new tt().fromArray(_e),We=new tt().fromArray(He);function $(L,ne,Z,oe){let fe=new Uint8Array(4),Q=i.createTexture();i.bindTexture(L,Q),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ye=0;ye<Z;ye++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(ne,0,i.RGBA,1,1,oe,0,i.RGBA,i.UNSIGNED_BYTE,fe):i.texImage2D(ne+ye,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,fe);return Q}let ie={};ie[i.TEXTURE_2D]=$(i.TEXTURE_2D,i.TEXTURE_2D,1),ie[i.TEXTURE_CUBE_MAP]=$(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ie[i.TEXTURE_2D_ARRAY]=$(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ie[i.TEXTURE_3D]=$(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ee(i.DEPTH_TEST),a.setFunc(ii),ut(!1),pt(eo),ee(i.CULL_FACE),Xe(un);function ee(L){d[L]!==!0&&(i.enable(L),d[L]=!0)}function Re(L){d[L]!==!1&&(i.disable(L),d[L]=!1)}function Pe(L,ne){return h[L]!==ne?(i.bindFramebuffer(L,ne),h[L]=ne,L===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ne),L===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ne),!0):!1}function Te(L,ne){let Z=x,oe=!1;if(L){Z=g.get(ne),Z===void 0&&(Z=[],g.set(ne,Z));let fe=L.textures;if(Z.length!==fe.length||Z[0]!==i.COLOR_ATTACHMENT0){for(let Q=0,ye=fe.length;Q<ye;Q++)Z[Q]=i.COLOR_ATTACHMENT0+Q;Z.length=fe.length,oe=!0}}else Z[0]!==i.BACK&&(Z[0]=i.BACK,oe=!0);oe&&i.drawBuffers(Z)}function lt(L){return M!==L?(i.useProgram(L),M=L,!0):!1}let Oe={[Fn]:i.FUNC_ADD,[Ml]:i.FUNC_SUBTRACT,[Sl]:i.FUNC_REVERSE_SUBTRACT};Oe[bl]=i.MIN,Oe[El]=i.MAX;let Je={[Tl]:i.ZERO,[Al]:i.ONE,[wl]:i.SRC_COLOR,[Hs]:i.SRC_ALPHA,[Dl]:i.SRC_ALPHA_SATURATE,[Pl]:i.DST_COLOR,[Rl]:i.DST_ALPHA,[Cl]:i.ONE_MINUS_SRC_COLOR,[Ws]:i.ONE_MINUS_SRC_ALPHA,[Ll]:i.ONE_MINUS_DST_COLOR,[Il]:i.ONE_MINUS_DST_ALPHA,[Nl]:i.CONSTANT_COLOR,[Ul]:i.ONE_MINUS_CONSTANT_COLOR,[Fl]:i.CONSTANT_ALPHA,[Ol]:i.ONE_MINUS_CONSTANT_ALPHA};function Xe(L,ne,Z,oe,fe,Q,ye,xe,at,Qe){if(L===un){m===!0&&(Re(i.BLEND),m=!1);return}if(m===!1&&(ee(i.BLEND),m=!0),L!==yl){if(L!==u||Qe!==R){if((w!==Fn||T!==Fn)&&(i.blendEquation(i.FUNC_ADD),w=Fn,T=Fn),Qe)switch(L){case ni:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case to:i.blendFunc(i.ONE,i.ONE);break;case no:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case io:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ce("WebGLState: Invalid blending: ",L);break}else switch(L){case ni:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case to:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case no:Ce("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case io:Ce("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ce("WebGLState: Invalid blending: ",L);break}P=null,y=null,E=null,C=null,_.set(0,0,0),b=0,u=L,R=Qe}return}fe=fe||ne,Q=Q||Z,ye=ye||oe,(ne!==w||fe!==T)&&(i.blendEquationSeparate(Oe[ne],Oe[fe]),w=ne,T=fe),(Z!==P||oe!==y||Q!==E||ye!==C)&&(i.blendFuncSeparate(Je[Z],Je[oe],Je[Q],Je[ye]),P=Z,y=oe,E=Q,C=ye),(xe.equals(_)===!1||at!==b)&&(i.blendColor(xe.r,xe.g,xe.b,at),_.copy(xe),b=at),u=L,R=!1}function ke(L,ne){L.side===hn?Re(i.CULL_FACE):ee(i.CULL_FACE);let Z=L.side===Rt;ne&&(Z=!Z),ut(Z),L.blending===ni&&L.transparent===!1?Xe(un):Xe(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),r.setMask(L.colorWrite);let oe=L.stencilWrite;o.setTest(oe),oe&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),Mt(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?ee(i.SAMPLE_ALPHA_TO_COVERAGE):Re(i.SAMPLE_ALPHA_TO_COVERAGE)}function ut(L){A!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),A=L)}function pt(L){L!==_l?(ee(i.CULL_FACE),L!==I&&(L===eo?i.cullFace(i.BACK):L===xl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Re(i.CULL_FACE),I=L}function _t(L){L!==O&&(X&&i.lineWidth(L),O=L)}function Mt(L,ne,Z){L?(ee(i.POLYGON_OFFSET_FILL),(H!==ne||B!==Z)&&(H=ne,B=Z,a.getReversed()&&(ne=-ne),i.polygonOffset(ne,Z))):Re(i.POLYGON_OFFSET_FILL)}function rt(L){L?ee(i.SCISSOR_TEST):Re(i.SCISSOR_TEST)}function dt(L){L===void 0&&(L=i.TEXTURE0+W-1),he!==L&&(i.activeTexture(L),he=L)}function D(L,ne,Z){Z===void 0&&(he===null?Z=i.TEXTURE0+W-1:Z=he);let oe=pe[Z];oe===void 0&&(oe={type:void 0,texture:void 0},pe[Z]=oe),(oe.type!==L||oe.texture!==ne)&&(he!==Z&&(i.activeTexture(Z),he=Z),i.bindTexture(L,ne||ie[L]),oe.type=L,oe.texture=ne)}function It(){let L=pe[he];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function Ye(){try{i.compressedTexImage2D(...arguments)}catch(L){Ce("WebGLState:",L)}}function S(){try{i.compressedTexImage3D(...arguments)}catch(L){Ce("WebGLState:",L)}}function f(){try{i.texSubImage2D(...arguments)}catch(L){Ce("WebGLState:",L)}}function U(){try{i.texSubImage3D(...arguments)}catch(L){Ce("WebGLState:",L)}}function k(){try{i.compressedTexSubImage2D(...arguments)}catch(L){Ce("WebGLState:",L)}}function q(){try{i.compressedTexSubImage3D(...arguments)}catch(L){Ce("WebGLState:",L)}}function te(){try{i.texStorage2D(...arguments)}catch(L){Ce("WebGLState:",L)}}function se(){try{i.texStorage3D(...arguments)}catch(L){Ce("WebGLState:",L)}}function Y(){try{i.texImage2D(...arguments)}catch(L){Ce("WebGLState:",L)}}function J(){try{i.texImage3D(...arguments)}catch(L){Ce("WebGLState:",L)}}function re(L){return p[L]!==void 0?p[L]:i.getParameter(L)}function Me(L,ne){p[L]!==ne&&(i.pixelStorei(L,ne),p[L]=ne)}function le(L){st.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),st.copy(L))}function ae(L){We.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),We.copy(L))}function Ee(L,ne){let Z=l.get(ne);Z===void 0&&(Z=new WeakMap,l.set(ne,Z));let oe=Z.get(L);oe===void 0&&(oe=i.getUniformBlockIndex(ne,L.name),Z.set(L,oe))}function Ae(L,ne){let oe=l.get(ne).get(L);c.get(ne)!==oe&&(i.uniformBlockBinding(ne,oe,L.__bindingPointIndex),c.set(ne,oe))}function Le(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},p={},he=null,pe={},h={},g=new WeakMap,x=[],M=null,m=!1,u=null,w=null,P=null,y=null,T=null,E=null,C=null,_=new Fe(0,0,0),b=0,R=!1,A=null,I=null,O=null,H=null,B=null,st.set(0,0,i.canvas.width,i.canvas.height),We.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ee,disable:Re,bindFramebuffer:Pe,drawBuffers:Te,useProgram:lt,setBlending:Xe,setMaterial:ke,setFlipSided:ut,setCullFace:pt,setLineWidth:_t,setPolygonOffset:Mt,setScissorTest:rt,activeTexture:dt,bindTexture:D,unbindTexture:It,compressedTexImage2D:Ye,compressedTexImage3D:S,texImage2D:Y,texImage3D:J,pixelStorei:Me,getParameter:re,updateUBOMapping:Ee,uniformBlockBinding:Ae,texStorage2D:te,texStorage3D:se,texSubImage2D:f,texSubImage3D:U,compressedTexSubImage2D:k,compressedTexSubImage3D:q,scissor:le,viewport:ae,reset:Le}}function Kp(i,e,t,n,s,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new ze,d=new WeakMap,p=new Set,h,g=new WeakMap,x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(S,f){return x?new OffscreenCanvas(S,f):Yi("canvas")}function m(S,f,U){let k=1,q=Ye(S);if((q.width>U||q.height>U)&&(k=U/Math.max(q.width,q.height)),k<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){let te=Math.floor(k*q.width),se=Math.floor(k*q.height);h===void 0&&(h=M(te,se));let Y=f?M(te,se):h;return Y.width=te,Y.height=se,Y.getContext("2d").drawImage(S,0,0,te,se),we("WebGLRenderer: Texture has been resized from ("+q.width+"x"+q.height+") to ("+te+"x"+se+")."),Y}else return"data"in S&&we("WebGLRenderer: Image in DataTexture is too big ("+q.width+"x"+q.height+")."),S;return S}function u(S){return S.generateMipmaps}function w(S){i.generateMipmap(S)}function P(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function y(S,f,U,k,q,te=!1){if(S!==null){if(i[S]!==void 0)return i[S];we("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let se;k&&(se=e.get("EXT_texture_norm16"),se||we("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=f;if(f===i.RED&&(U===i.FLOAT&&(Y=i.R32F),U===i.HALF_FLOAT&&(Y=i.R16F),U===i.UNSIGNED_BYTE&&(Y=i.R8),U===i.UNSIGNED_SHORT&&se&&(Y=se.R16_EXT),U===i.SHORT&&se&&(Y=se.R16_SNORM_EXT)),f===i.RED_INTEGER&&(U===i.UNSIGNED_BYTE&&(Y=i.R8UI),U===i.UNSIGNED_SHORT&&(Y=i.R16UI),U===i.UNSIGNED_INT&&(Y=i.R32UI),U===i.BYTE&&(Y=i.R8I),U===i.SHORT&&(Y=i.R16I),U===i.INT&&(Y=i.R32I)),f===i.RG&&(U===i.FLOAT&&(Y=i.RG32F),U===i.HALF_FLOAT&&(Y=i.RG16F),U===i.UNSIGNED_BYTE&&(Y=i.RG8),U===i.UNSIGNED_SHORT&&se&&(Y=se.RG16_EXT),U===i.SHORT&&se&&(Y=se.RG16_SNORM_EXT)),f===i.RG_INTEGER&&(U===i.UNSIGNED_BYTE&&(Y=i.RG8UI),U===i.UNSIGNED_SHORT&&(Y=i.RG16UI),U===i.UNSIGNED_INT&&(Y=i.RG32UI),U===i.BYTE&&(Y=i.RG8I),U===i.SHORT&&(Y=i.RG16I),U===i.INT&&(Y=i.RG32I)),f===i.RGB_INTEGER&&(U===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),U===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),U===i.UNSIGNED_INT&&(Y=i.RGB32UI),U===i.BYTE&&(Y=i.RGB8I),U===i.SHORT&&(Y=i.RGB16I),U===i.INT&&(Y=i.RGB32I)),f===i.RGBA_INTEGER&&(U===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),U===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),U===i.UNSIGNED_INT&&(Y=i.RGBA32UI),U===i.BYTE&&(Y=i.RGBA8I),U===i.SHORT&&(Y=i.RGBA16I),U===i.INT&&(Y=i.RGBA32I)),f===i.RGB&&(U===i.UNSIGNED_SHORT&&se&&(Y=se.RGB16_EXT),U===i.SHORT&&se&&(Y=se.RGB16_SNORM_EXT),U===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),U===i.UNSIGNED_INT_10F_11F_11F_REV&&(Y=i.R11F_G11F_B10F)),f===i.RGBA){let J=te?qi:Be.getTransfer(q);U===i.FLOAT&&(Y=i.RGBA32F),U===i.HALF_FLOAT&&(Y=i.RGBA16F),U===i.UNSIGNED_BYTE&&(Y=J===qe?i.SRGB8_ALPHA8:i.RGBA8),U===i.UNSIGNED_SHORT&&se&&(Y=se.RGBA16_EXT),U===i.SHORT&&se&&(Y=se.RGBA16_SNORM_EXT),U===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),U===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function T(S,f){let U;return S?f===null||f===Kt||f===Ui?U=i.DEPTH24_STENCIL8:f===Qt?U=i.DEPTH32F_STENCIL8:f===Ni&&(U=i.DEPTH24_STENCIL8,we("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):f===null||f===Kt||f===Ui?U=i.DEPTH_COMPONENT24:f===Qt?U=i.DEPTH_COMPONENT32F:f===Ni&&(U=i.DEPTH_COMPONENT16),U}function E(S,f){return u(S)===!0||S.isFramebufferTexture&&S.minFilter!==yt&&S.minFilter!==St?Math.log2(Math.max(f.width,f.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?f.mipmaps.length:1}function C(S){let f=S.target;f.removeEventListener("dispose",C),b(f),f.isVideoTexture&&d.delete(f),f.isHTMLTexture&&p.delete(f)}function _(S){let f=S.target;f.removeEventListener("dispose",_),A(f)}function b(S){let f=n.get(S);if(f.__webglInit===void 0)return;let U=S.source,k=g.get(U);if(k){let q=k[f.__cacheKey];q.usedTimes--,q.usedTimes===0&&R(S),Object.keys(k).length===0&&g.delete(U)}n.remove(S)}function R(S){let f=n.get(S);i.deleteTexture(f.__webglTexture);let U=S.source,k=g.get(U);delete k[f.__cacheKey],a.memory.textures--}function A(S){let f=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(f.__webglFramebuffer[k]))for(let q=0;q<f.__webglFramebuffer[k].length;q++)i.deleteFramebuffer(f.__webglFramebuffer[k][q]);else i.deleteFramebuffer(f.__webglFramebuffer[k]);f.__webglDepthbuffer&&i.deleteRenderbuffer(f.__webglDepthbuffer[k])}else{if(Array.isArray(f.__webglFramebuffer))for(let k=0;k<f.__webglFramebuffer.length;k++)i.deleteFramebuffer(f.__webglFramebuffer[k]);else i.deleteFramebuffer(f.__webglFramebuffer);if(f.__webglDepthbuffer&&i.deleteRenderbuffer(f.__webglDepthbuffer),f.__webglMultisampledFramebuffer&&i.deleteFramebuffer(f.__webglMultisampledFramebuffer),f.__webglColorRenderbuffer)for(let k=0;k<f.__webglColorRenderbuffer.length;k++)f.__webglColorRenderbuffer[k]&&i.deleteRenderbuffer(f.__webglColorRenderbuffer[k]);f.__webglDepthRenderbuffer&&i.deleteRenderbuffer(f.__webglDepthRenderbuffer)}let U=S.textures;for(let k=0,q=U.length;k<q;k++){let te=n.get(U[k]);te.__webglTexture&&(i.deleteTexture(te.__webglTexture),a.memory.textures--),n.remove(U[k])}n.remove(S)}let I=0;function O(){I=0}function H(){return I}function B(S){I=S}function W(){let S=I;return S>=s.maxTextures&&we("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),I+=1,S}function X(S){let f=[];return f.push(S.wrapS),f.push(S.wrapT),f.push(S.wrapR||0),f.push(S.magFilter),f.push(S.minFilter),f.push(S.anisotropy),f.push(S.internalFormat),f.push(S.format),f.push(S.type),f.push(S.generateMipmaps),f.push(S.premultiplyAlpha),f.push(S.flipY),f.push(S.unpackAlignment),f.push(S.colorSpace),f.join()}function K(S,f){let U=n.get(S);if(S.isVideoTexture&&D(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&U.__version!==S.version){let k=S.image;if(k===null)we("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)we("WebGLRenderer: Texture marked for update but image is incomplete");else{Re(U,S,f);return}}else S.isExternalTexture&&(U.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,U.__webglTexture,i.TEXTURE0+f)}function j(S,f){let U=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&U.__version!==S.version){Re(U,S,f);return}else S.isExternalTexture&&(U.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,U.__webglTexture,i.TEXTURE0+f)}function he(S,f){let U=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&U.__version!==S.version){Re(U,S,f);return}t.bindTexture(i.TEXTURE_3D,U.__webglTexture,i.TEXTURE0+f)}function pe(S,f){let U=n.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&U.__version!==S.version){Pe(U,S,f);return}t.bindTexture(i.TEXTURE_CUBE_MAP,U.__webglTexture,i.TEXTURE0+f)}let _e={[Qs]:i.REPEAT,[rn]:i.CLAMP_TO_EDGE,[js]:i.MIRRORED_REPEAT},He={[yt]:i.NEAREST,[Vl]:i.NEAREST_MIPMAP_NEAREST,[cs]:i.NEAREST_MIPMAP_LINEAR,[St]:i.LINEAR,[Tr]:i.LINEAR_MIPMAP_NEAREST,[Xn]:i.LINEAR_MIPMAP_LINEAR},st={[Hl]:i.NEVER,[Zl]:i.ALWAYS,[Wl]:i.LESS,[ca]:i.LEQUAL,[Xl]:i.EQUAL,[ha]:i.GEQUAL,[ql]:i.GREATER,[Yl]:i.NOTEQUAL};function We(S,f){if(f.type===Qt&&e.has("OES_texture_float_linear")===!1&&(f.magFilter===St||f.magFilter===Tr||f.magFilter===cs||f.magFilter===Xn||f.minFilter===St||f.minFilter===Tr||f.minFilter===cs||f.minFilter===Xn)&&we("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,_e[f.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,_e[f.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,_e[f.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,He[f.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,He[f.minFilter]),f.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,st[f.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(f.magFilter===yt||f.minFilter!==cs&&f.minFilter!==Xn||f.type===Qt&&e.has("OES_texture_float_linear")===!1)return;if(f.anisotropy>1||n.get(f).__currentAnisotropy){let U=e.get("EXT_texture_filter_anisotropic");i.texParameterf(S,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(f.anisotropy,s.getMaxAnisotropy())),n.get(f).__currentAnisotropy=f.anisotropy}}}function $(S,f){let U=!1;S.__webglInit===void 0&&(S.__webglInit=!0,f.addEventListener("dispose",C));let k=f.source,q=g.get(k);q===void 0&&(q={},g.set(k,q));let te=X(f);if(te!==S.__cacheKey){q[te]===void 0&&(q[te]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,U=!0),q[te].usedTimes++;let se=q[S.__cacheKey];se!==void 0&&(q[S.__cacheKey].usedTimes--,se.usedTimes===0&&R(f)),S.__cacheKey=te,S.__webglTexture=q[te].texture}return U}function ie(S,f,U){return Math.floor(Math.floor(S/U)/f)}function ee(S,f,U,k){let te=S.updateRanges;if(te.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,f.width,f.height,U,k,f.data);else{te.sort((Me,le)=>Me.start-le.start);let se=0;for(let Me=1;Me<te.length;Me++){let le=te[se],ae=te[Me],Ee=le.start+le.count,Ae=ie(ae.start,f.width,4),Le=ie(le.start,f.width,4);ae.start<=Ee+1&&Ae===Le&&ie(ae.start+ae.count-1,f.width,4)===Ae?le.count=Math.max(le.count,ae.start+ae.count-le.start):(++se,te[se]=ae)}te.length=se+1;let Y=t.getParameter(i.UNPACK_ROW_LENGTH),J=t.getParameter(i.UNPACK_SKIP_PIXELS),re=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,f.width);for(let Me=0,le=te.length;Me<le;Me++){let ae=te[Me],Ee=Math.floor(ae.start/4),Ae=Math.ceil(ae.count/4),Le=Ee%f.width,L=Math.floor(Ee/f.width),ne=Ae,Z=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Le),t.pixelStorei(i.UNPACK_SKIP_ROWS,L),t.texSubImage2D(i.TEXTURE_2D,0,Le,L,ne,Z,U,k,f.data)}S.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,Y),t.pixelStorei(i.UNPACK_SKIP_PIXELS,J),t.pixelStorei(i.UNPACK_SKIP_ROWS,re)}}function Re(S,f,U){let k=i.TEXTURE_2D;(f.isDataArrayTexture||f.isCompressedArrayTexture)&&(k=i.TEXTURE_2D_ARRAY),f.isData3DTexture&&(k=i.TEXTURE_3D);let q=$(S,f),te=f.source;t.bindTexture(k,S.__webglTexture,i.TEXTURE0+U);let se=n.get(te);if(te.version!==se.__version||q===!0){if(t.activeTexture(i.TEXTURE0+U),(typeof ImageBitmap<"u"&&f.image instanceof ImageBitmap)===!1){let Z=Be.getPrimaries(Be.workingColorSpace),oe=f.colorSpace===Tn?null:Be.getPrimaries(f.colorSpace),fe=f.colorSpace===Tn||Z===oe?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,f.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,f.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe)}t.pixelStorei(i.UNPACK_ALIGNMENT,f.unpackAlignment);let J=m(f.image,!1,s.maxTextureSize);J=It(f,J);let re=r.convert(f.format,f.colorSpace),Me=r.convert(f.type),le=y(f.internalFormat,re,Me,f.normalized,f.colorSpace,f.isVideoTexture);We(k,f);let ae,Ee=f.mipmaps,Ae=f.isVideoTexture!==!0,Le=se.__version===void 0||q===!0,L=te.dataReady,ne=E(f,J);if(f.isDepthTexture)le=T(f.format===qn,f.type),Le&&(Ae?t.texStorage2D(i.TEXTURE_2D,1,le,J.width,J.height):t.texImage2D(i.TEXTURE_2D,0,le,J.width,J.height,0,re,Me,null));else if(f.isDataTexture)if(Ee.length>0){Ae&&Le&&t.texStorage2D(i.TEXTURE_2D,ne,le,Ee[0].width,Ee[0].height);for(let Z=0,oe=Ee.length;Z<oe;Z++)ae=Ee[Z],Ae?L&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,ae.width,ae.height,re,Me,ae.data):t.texImage2D(i.TEXTURE_2D,Z,le,ae.width,ae.height,0,re,Me,ae.data);f.generateMipmaps=!1}else Ae?(Le&&t.texStorage2D(i.TEXTURE_2D,ne,le,J.width,J.height),L&&ee(f,J,re,Me)):t.texImage2D(i.TEXTURE_2D,0,le,J.width,J.height,0,re,Me,J.data);else if(f.isCompressedTexture)if(f.isCompressedArrayTexture){Ae&&Le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ne,le,Ee[0].width,Ee[0].height,J.depth);for(let Z=0,oe=Ee.length;Z<oe;Z++)if(ae=Ee[Z],f.format!==Xt)if(re!==null)if(Ae){if(L)if(f.layerUpdates.size>0){let fe=Ao(ae.width,ae.height,f.format,f.type);for(let Q of f.layerUpdates){let ye=ae.data.subarray(Q*fe/ae.data.BYTES_PER_ELEMENT,(Q+1)*fe/ae.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,Q,ae.width,ae.height,1,re,ye)}f.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,ae.width,ae.height,J.depth,re,ae.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Z,le,ae.width,ae.height,J.depth,0,ae.data,0,0);else we("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ae?L&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,ae.width,ae.height,J.depth,re,Me,ae.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Z,le,ae.width,ae.height,J.depth,0,re,Me,ae.data)}else{Ae&&Le&&t.texStorage2D(i.TEXTURE_2D,ne,le,Ee[0].width,Ee[0].height);for(let Z=0,oe=Ee.length;Z<oe;Z++)ae=Ee[Z],f.format!==Xt?re!==null?Ae?L&&t.compressedTexSubImage2D(i.TEXTURE_2D,Z,0,0,ae.width,ae.height,re,ae.data):t.compressedTexImage2D(i.TEXTURE_2D,Z,le,ae.width,ae.height,0,ae.data):we("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ae?L&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,ae.width,ae.height,re,Me,ae.data):t.texImage2D(i.TEXTURE_2D,Z,le,ae.width,ae.height,0,re,Me,ae.data)}else if(f.isDataArrayTexture)if(Ae){if(Le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ne,le,J.width,J.height,J.depth),L)if(f.layerUpdates.size>0){let Z=Ao(J.width,J.height,f.format,f.type);for(let oe of f.layerUpdates){let fe=J.data.subarray(oe*Z/J.data.BYTES_PER_ELEMENT,(oe+1)*Z/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,oe,J.width,J.height,1,re,Me,fe)}f.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,re,Me,J.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,le,J.width,J.height,J.depth,0,re,Me,J.data);else if(f.isData3DTexture)Ae?(Le&&t.texStorage3D(i.TEXTURE_3D,ne,le,J.width,J.height,J.depth),L&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,re,Me,J.data)):t.texImage3D(i.TEXTURE_3D,0,le,J.width,J.height,J.depth,0,re,Me,J.data);else if(f.isFramebufferTexture){if(Le)if(Ae)t.texStorage2D(i.TEXTURE_2D,ne,le,J.width,J.height);else{let Z=J.width,oe=J.height;for(let fe=0;fe<ne;fe++)t.texImage2D(i.TEXTURE_2D,fe,le,Z,oe,0,re,Me,null),Z>>=1,oe>>=1}}else if(f.isHTMLTexture){if("texElementImage2D"in i){let Z=i.canvas;if(Z.hasAttribute("layoutsubtree")||Z.setAttribute("layoutsubtree","true"),J.parentNode!==Z){Z.appendChild(J),p.add(f),Z.onpaint=oe=>{let fe=oe.changedElements;for(let Q of p)fe.includes(Q.image)&&(Q.needsUpdate=!0)},Z.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,J);else{let fe=i.RGBA,Q=i.RGBA,ye=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,fe,Q,ye,J)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ee.length>0){if(Ae&&Le){let Z=Ye(Ee[0]);t.texStorage2D(i.TEXTURE_2D,ne,le,Z.width,Z.height)}for(let Z=0,oe=Ee.length;Z<oe;Z++)ae=Ee[Z],Ae?L&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,re,Me,ae):t.texImage2D(i.TEXTURE_2D,Z,le,re,Me,ae);f.generateMipmaps=!1}else if(Ae){if(Le){let Z=Ye(J);t.texStorage2D(i.TEXTURE_2D,ne,le,Z.width,Z.height)}L&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,re,Me,J)}else t.texImage2D(i.TEXTURE_2D,0,le,re,Me,J);u(f)&&w(k),se.__version=te.version,f.onUpdate&&f.onUpdate(f)}S.__version=f.version}function Pe(S,f,U){if(f.image.length!==6)return;let k=$(S,f),q=f.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+U);let te=n.get(q);if(q.version!==te.__version||k===!0){t.activeTexture(i.TEXTURE0+U);let se=Be.getPrimaries(Be.workingColorSpace),Y=f.colorSpace===Tn?null:Be.getPrimaries(f.colorSpace),J=f.colorSpace===Tn||se===Y?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,f.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,f.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,f.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);let re=f.isCompressedTexture||f.image[0].isCompressedTexture,Me=f.image[0]&&f.image[0].isDataTexture,le=[];for(let Q=0;Q<6;Q++)!re&&!Me?le[Q]=m(f.image[Q],!0,s.maxCubemapSize):le[Q]=Me?f.image[Q].image:f.image[Q],le[Q]=It(f,le[Q]);let ae=le[0],Ee=r.convert(f.format,f.colorSpace),Ae=r.convert(f.type),Le=y(f.internalFormat,Ee,Ae,f.normalized,f.colorSpace),L=f.isVideoTexture!==!0,ne=te.__version===void 0||k===!0,Z=q.dataReady,oe=E(f,ae);We(i.TEXTURE_CUBE_MAP,f);let fe;if(re){L&&ne&&t.texStorage2D(i.TEXTURE_CUBE_MAP,oe,Le,ae.width,ae.height);for(let Q=0;Q<6;Q++){fe=le[Q].mipmaps;for(let ye=0;ye<fe.length;ye++){let xe=fe[ye];f.format!==Xt?Ee!==null?L?Z&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,0,0,xe.width,xe.height,Ee,xe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,Le,xe.width,xe.height,0,xe.data):we("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,0,0,xe.width,xe.height,Ee,Ae,xe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye,Le,xe.width,xe.height,0,Ee,Ae,xe.data)}}}else{if(fe=f.mipmaps,L&&ne){fe.length>0&&oe++;let Q=Ye(le[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,oe,Le,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(Me){L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,le[Q].width,le[Q].height,Ee,Ae,le[Q].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Le,le[Q].width,le[Q].height,0,Ee,Ae,le[Q].data);for(let ye=0;ye<fe.length;ye++){let at=fe[ye].image[Q].image;L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,0,0,at.width,at.height,Ee,Ae,at.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,Le,at.width,at.height,0,Ee,Ae,at.data)}}else{L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Ee,Ae,le[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Le,Ee,Ae,le[Q]);for(let ye=0;ye<fe.length;ye++){let xe=fe[ye];L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,0,0,Ee,Ae,xe.image[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,ye+1,Le,Ee,Ae,xe.image[Q])}}}u(f)&&w(i.TEXTURE_CUBE_MAP),te.__version=q.version,f.onUpdate&&f.onUpdate(f)}S.__version=f.version}function Te(S,f,U,k,q,te){let se=r.convert(U.format,U.colorSpace),Y=r.convert(U.type),J=y(U.internalFormat,se,Y,U.normalized,U.colorSpace),re=n.get(f),Me=n.get(U);if(Me.__renderTarget=f,!re.__hasExternalTextures){let le=Math.max(1,f.width>>te),ae=Math.max(1,f.height>>te);q===i.TEXTURE_3D||q===i.TEXTURE_2D_ARRAY?t.texImage3D(q,te,J,le,ae,f.depth,0,se,Y,null):t.texImage2D(q,te,J,le,ae,0,se,Y,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),dt(f)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,k,q,Me.__webglTexture,0,rt(f)):(q===i.TEXTURE_2D||q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,k,q,Me.__webglTexture,te),t.bindFramebuffer(i.FRAMEBUFFER,null)}function lt(S,f,U){if(i.bindRenderbuffer(i.RENDERBUFFER,S),f.depthBuffer){let k=f.depthTexture,q=k&&k.isDepthTexture?k.type:null,te=T(f.stencilBuffer,q),se=f.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;dt(f)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,rt(f),te,f.width,f.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,rt(f),te,f.width,f.height):i.renderbufferStorage(i.RENDERBUFFER,te,f.width,f.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,se,i.RENDERBUFFER,S)}else{let k=f.textures;for(let q=0;q<k.length;q++){let te=k[q],se=r.convert(te.format,te.colorSpace),Y=r.convert(te.type),J=y(te.internalFormat,se,Y,te.normalized,te.colorSpace);dt(f)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,rt(f),J,f.width,f.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,rt(f),J,f.width,f.height):i.renderbufferStorage(i.RENDERBUFFER,J,f.width,f.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Oe(S,f,U){let k=f.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(f.depthTexture&&f.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let q=n.get(f.depthTexture);if(q.__renderTarget=f,(!q.__webglTexture||f.depthTexture.image.width!==f.width||f.depthTexture.image.height!==f.height)&&(f.depthTexture.image.width=f.width,f.depthTexture.image.height=f.height,f.depthTexture.needsUpdate=!0),k){if(q.__webglInit===void 0&&(q.__webglInit=!0,f.depthTexture.addEventListener("dispose",C)),q.__webglTexture===void 0){q.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),We(i.TEXTURE_CUBE_MAP,f.depthTexture);let re=r.convert(f.depthTexture.format),Me=r.convert(f.depthTexture.type),le;f.depthTexture.format===an?le=i.DEPTH_COMPONENT24:f.depthTexture.format===qn&&(le=i.DEPTH24_STENCIL8);for(let ae=0;ae<6;ae++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,le,f.width,f.height,0,re,Me,null)}}else K(f.depthTexture,0);let te=q.__webglTexture,se=rt(f),Y=k?i.TEXTURE_CUBE_MAP_POSITIVE_X+U:i.TEXTURE_2D,J=f.depthTexture.format===qn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(f.depthTexture.format===an)dt(f)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,Y,te,0,se):i.framebufferTexture2D(i.FRAMEBUFFER,J,Y,te,0);else if(f.depthTexture.format===qn)dt(f)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,Y,te,0,se):i.framebufferTexture2D(i.FRAMEBUFFER,J,Y,te,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Je(S){let f=n.get(S),U=S.isWebGLCubeRenderTarget===!0;if(f.__boundDepthTexture!==S.depthTexture){let k=S.depthTexture;if(f.__depthDisposeCallback&&f.__depthDisposeCallback(),k){let q=()=>{delete f.__boundDepthTexture,delete f.__depthDisposeCallback,k.removeEventListener("dispose",q)};k.addEventListener("dispose",q),f.__depthDisposeCallback=q}f.__boundDepthTexture=k}if(S.depthTexture&&!f.__autoAllocateDepthBuffer)if(U)for(let k=0;k<6;k++)Oe(f.__webglFramebuffer[k],S,k);else{let k=S.texture.mipmaps;k&&k.length>0?Oe(f.__webglFramebuffer[0],S,0):Oe(f.__webglFramebuffer,S,0)}else if(U){f.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(t.bindFramebuffer(i.FRAMEBUFFER,f.__webglFramebuffer[k]),f.__webglDepthbuffer[k]===void 0)f.__webglDepthbuffer[k]=i.createRenderbuffer(),lt(f.__webglDepthbuffer[k],S,!1);else{let q=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,te=f.__webglDepthbuffer[k];i.bindRenderbuffer(i.RENDERBUFFER,te),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,te)}}else{let k=S.texture.mipmaps;if(k&&k.length>0?t.bindFramebuffer(i.FRAMEBUFFER,f.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,f.__webglFramebuffer),f.__webglDepthbuffer===void 0)f.__webglDepthbuffer=i.createRenderbuffer(),lt(f.__webglDepthbuffer,S,!1);else{let q=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,te=f.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,te),i.framebufferRenderbuffer(i.FRAMEBUFFER,q,i.RENDERBUFFER,te)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Xe(S,f,U){let k=n.get(S);f!==void 0&&Te(k.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),U!==void 0&&Je(S)}function ke(S){let f=S.texture,U=n.get(S),k=n.get(f);S.addEventListener("dispose",_);let q=S.textures,te=S.isWebGLCubeRenderTarget===!0,se=q.length>1;if(se||(k.__webglTexture===void 0&&(k.__webglTexture=i.createTexture()),k.__version=f.version,a.memory.textures++),te){U.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(f.mipmaps&&f.mipmaps.length>0){U.__webglFramebuffer[Y]=[];for(let J=0;J<f.mipmaps.length;J++)U.__webglFramebuffer[Y][J]=i.createFramebuffer()}else U.__webglFramebuffer[Y]=i.createFramebuffer()}else{if(f.mipmaps&&f.mipmaps.length>0){U.__webglFramebuffer=[];for(let Y=0;Y<f.mipmaps.length;Y++)U.__webglFramebuffer[Y]=i.createFramebuffer()}else U.__webglFramebuffer=i.createFramebuffer();if(se)for(let Y=0,J=q.length;Y<J;Y++){let re=n.get(q[Y]);re.__webglTexture===void 0&&(re.__webglTexture=i.createTexture(),a.memory.textures++)}if(S.samples>0&&dt(S)===!1){U.__webglMultisampledFramebuffer=i.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let Y=0;Y<q.length;Y++){let J=q[Y];U.__webglColorRenderbuffer[Y]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,U.__webglColorRenderbuffer[Y]);let re=r.convert(J.format,J.colorSpace),Me=r.convert(J.type),le=y(J.internalFormat,re,Me,J.normalized,J.colorSpace,S.isXRRenderTarget===!0),ae=rt(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,ae,le,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Y,i.RENDERBUFFER,U.__webglColorRenderbuffer[Y])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(U.__webglDepthRenderbuffer=i.createRenderbuffer(),lt(U.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(te){t.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture),We(i.TEXTURE_CUBE_MAP,f);for(let Y=0;Y<6;Y++)if(f.mipmaps&&f.mipmaps.length>0)for(let J=0;J<f.mipmaps.length;J++)Te(U.__webglFramebuffer[Y][J],S,f,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,J);else Te(U.__webglFramebuffer[Y],S,f,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);u(f)&&w(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(se){for(let Y=0,J=q.length;Y<J;Y++){let re=q[Y],Me=n.get(re),le=i.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(le=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(le,Me.__webglTexture),We(le,re),Te(U.__webglFramebuffer,S,re,i.COLOR_ATTACHMENT0+Y,le,0),u(re)&&w(le)}t.unbindTexture()}else{let Y=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(Y=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Y,k.__webglTexture),We(Y,f),f.mipmaps&&f.mipmaps.length>0)for(let J=0;J<f.mipmaps.length;J++)Te(U.__webglFramebuffer[J],S,f,i.COLOR_ATTACHMENT0,Y,J);else Te(U.__webglFramebuffer,S,f,i.COLOR_ATTACHMENT0,Y,0);u(f)&&w(Y),t.unbindTexture()}S.depthBuffer&&Je(S)}function ut(S){let f=S.textures;for(let U=0,k=f.length;U<k;U++){let q=f[U];if(u(q)){let te=P(S),se=n.get(q).__webglTexture;t.bindTexture(te,se),w(te),t.unbindTexture()}}}let pt=[],_t=[];function Mt(S){if(S.samples>0){if(dt(S)===!1){let f=S.textures,U=S.width,k=S.height,q=i.COLOR_BUFFER_BIT,te=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,se=n.get(S),Y=f.length>1;if(Y)for(let re=0;re<f.length;re++)t.bindFramebuffer(i.FRAMEBUFFER,se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,se.__webglMultisampledFramebuffer);let J=S.texture.mipmaps;J&&J.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,se.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,se.__webglFramebuffer);for(let re=0;re<f.length;re++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(q|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(q|=i.STENCIL_BUFFER_BIT)),Y){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,se.__webglColorRenderbuffer[re]);let Me=n.get(f[re]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Me,0)}i.blitFramebuffer(0,0,U,k,0,0,U,k,q,i.NEAREST),c===!0&&(pt.length=0,_t.length=0,pt.push(i.COLOR_ATTACHMENT0+re),S.depthBuffer&&S.resolveDepthBuffer===!1&&(pt.push(te),_t.push(te),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,_t)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,pt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Y)for(let re=0;re<f.length;re++){t.bindFramebuffer(i.FRAMEBUFFER,se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.RENDERBUFFER,se.__webglColorRenderbuffer[re]);let Me=n.get(f[re]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.TEXTURE_2D,Me,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,se.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&c){let f=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[f])}}}function rt(S){return Math.min(s.maxSamples,S.samples)}function dt(S){let f=n.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&f.__useRenderToTexture!==!1}function D(S){let f=a.render.frame;d.get(S)!==f&&(d.set(S,f),S.update())}function It(S,f){let U=S.colorSpace,k=S.format,q=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||U!==Xi&&U!==Tn&&(Be.getTransfer(U)===qe?(k!==Xt||q!==Dt)&&we("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ce("WebGLTextures: Unsupported texture color space:",U)),f}function Ye(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(l.width=S.naturalWidth||S.width,l.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(l.width=S.displayWidth,l.height=S.displayHeight):(l.width=S.width,l.height=S.height),l}this.allocateTextureUnit=W,this.resetTextureUnits=O,this.getTextureUnits=H,this.setTextureUnits=B,this.setTexture2D=K,this.setTexture2DArray=j,this.setTexture3D=he,this.setTextureCube=pe,this.rebindTextures=Xe,this.setupRenderTarget=ke,this.updateRenderTargetMipmap=ut,this.updateMultisampleRenderTarget=Mt,this.setupDepthRenderbuffer=Je,this.setupFrameBufferTexture=Te,this.useMultisampledRTT=dt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Qp(i,e){function t(n,s=Tn){let r,a=Be.getTransfer(s);if(n===Dt)return i.UNSIGNED_BYTE;if(n===wr)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Cr)return i.UNSIGNED_SHORT_5_5_5_1;if(n===go)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===_o)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===po)return i.BYTE;if(n===mo)return i.SHORT;if(n===Ni)return i.UNSIGNED_SHORT;if(n===Ar)return i.INT;if(n===Kt)return i.UNSIGNED_INT;if(n===Qt)return i.FLOAT;if(n===dn)return i.HALF_FLOAT;if(n===xo)return i.ALPHA;if(n===vo)return i.RGB;if(n===Xt)return i.RGBA;if(n===an)return i.DEPTH_COMPONENT;if(n===qn)return i.DEPTH_STENCIL;if(n===yo)return i.RED;if(n===Rr)return i.RED_INTEGER;if(n===Yn)return i.RG;if(n===Ir)return i.RG_INTEGER;if(n===Pr)return i.RGBA_INTEGER;if(n===hs||n===us||n===ds||n===fs)if(a===qe)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===hs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===us)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ds)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===fs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===hs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===us)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ds)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===fs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Lr||n===Dr||n===Nr||n===Ur)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Lr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Dr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Nr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ur)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Fr||n===Or||n===Br||n===zr||n===Vr||n===ps||n===kr)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Fr||n===Or)return a===qe?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Br)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===zr)return r.COMPRESSED_R11_EAC;if(n===Vr)return r.COMPRESSED_SIGNED_R11_EAC;if(n===ps)return r.COMPRESSED_RG11_EAC;if(n===kr)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Gr||n===Hr||n===Wr||n===Xr||n===qr||n===Yr||n===Zr||n===Jr||n===$r||n===Kr||n===Qr||n===jr||n===ea||n===ta)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Gr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Hr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Wr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Xr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===qr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Yr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Zr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Jr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===$r)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Kr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Qr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===jr)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ea)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ta)return a===qe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===na||n===ia||n===sa)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===na)return a===qe?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ia)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===sa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ra||n===aa||n===ms||n===oa)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===ra)return r.COMPRESSED_RED_RGTC1_EXT;if(n===aa)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ms)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===oa)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ui?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}var jp=`
void main() {
...
}`,Vo=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new ts(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Vt({vertexShader:jp,fragmentShader:em,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new it(new si(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},ko=class extends on{constructor(e,t){super();let n=this,s=null,r=1,a=null,o="local-floor",c=1,l=null,d=null,p=null,h=null,g=null,x=null,M=typeof XRWebGLBinding<"u",m=new Vo,u={},w=t.getContextAttributes(),P=null,y=null,T=[],E=[],C=new ze,_=null,b=new At;b.viewport=new tt;let R=new At;R.viewport=new tt;let A=[b,R],I=new Sr,O=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let ie=T[$];return ie===void 0&&(ie=new wi,T[$]=ie),ie.getTargetRaySpace()},this.getControllerGrip=function($){let ie=T[$];return ie===void 0&&(ie=new wi,T[$]=ie),ie.getGripSpace()},this.getHand=function($){let ie=T[$];return ie===void 0&&(ie=new wi,T[$]=ie),ie.getHandSpace()};function B($){let ie=E.indexOf($.inputSource);if(ie===-1)return;let ee=T[ie];ee!==void 0&&(ee.update($.inputSource,$.frame,l||a),ee.dispatchEvent({type:$.type,data:$.inputSource}))}function W(){s.removeEventListener("select",B),s.removeEventListener("selectstart",B),s.removeEventListener("selectend",B),s.removeEventListener("squeeze",B),s.removeEventListener("squeezestart",B),s.removeEventListener("squeezeend",B),s.removeEventListener("end",W),s.removeEventListener("inputsourceschange",X);for(let $=0;$<T.length;$++){let ie=E[$];ie!==null&&(E[$]=null,T[$].disconnect(ie))}O=null,H=null,m.reset();for(let $ in u)delete u[$];e.setRenderTarget(P),g=null,h=null,p=null,s=null,y=null,We.stop(),n.isPresenting=!1,e.setPixelRatio(_),e.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){r=$,n.isPresenting===!0&&we("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){o=$,n.isPresenting===!0&&we("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function($){l=$},this.getBaseLayer=function(){return h!==null?h:g},this.getBinding=function(){return p===null&&M&&(p=new XRWebGLBinding(s,t)),p},this.getFrame=function(){return x},this.getSession=function(){return s},this.setSession=async function($){if(s=$,s!==null){if(P=e.getRenderTarget(),s.addEventListener("select",B),s.addEventListener("selectstart",B),s.addEventListener("selectend",B),s.addEventListener("squeeze",B),s.addEventListener("squeezestart",B),s.addEventListener("squeezeend",B),s.addEventListener("end",W),s.addEventListener("inputsourceschange",X),w.xrCompatible!==!0&&await t.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(C),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let ee=null,Re=null,Pe=null;w.depth&&(Pe=w.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ee=w.stencil?qn:an,Re=w.stencil?Ui:Kt);let Te={colorFormat:t.RGBA8,depthFormat:Pe,scaleFactor:r};p=this.getBinding(),h=p.createProjectionLayer(Te),s.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),y=new zt(h.textureWidth,h.textureHeight,{format:Xt,type:Dt,depthTexture:new En(h.textureWidth,h.textureHeight,Re,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:w.stencil,colorSpace:e.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{let ee={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:r};g=new XRWebGLLayer(s,t,ee),s.updateRenderState({baseLayer:g}),e.setPixelRatio(1),e.setSize(g.framebufferWidth,g.framebufferHeight,!1),y=new zt(g.framebufferWidth,g.framebufferHeight,{format:Xt,type:Dt,colorSpace:e.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await s.requestReferenceSpace(o),We.setContext(s),We.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function X($){for(let ie=0;ie<$.removed.length;ie++){let ee=$.removed[ie],Re=E.indexOf(ee);Re>=0&&(E[Re]=null,T[Re].disconnect(ee))}for(let ie=0;ie<$.added.length;ie++){let ee=$.added[ie],Re=E.indexOf(ee);if(Re===-1){for(let Te=0;Te<T.length;Te++)if(Te>=E.length){E.push(ee),Re=Te;break}else if(E[Te]===null){E[Te]=ee,Re=Te;break}if(Re===-1)break}let Pe=T[Re];Pe&&Pe.connect(ee)}}let K=new F,j=new F;function he($,ie,ee){K.setFromMatrixPosition(ie.matrixWorld),j.setFromMatrixPosition(ee.matrixWorld);let Re=K.distanceTo(j),Pe=ie.projectionMatrix.elements,Te=ee.projectionMatrix.elements,lt=Pe[14]/(Pe[10]-1),Oe=Pe[14]/(Pe[10]+1),Je=(Pe[9]+1)/Pe[5],Xe=(Pe[9]-1)/Pe[5],ke=(Pe[8]-1)/Pe[0],ut=(Te[8]+1)/Te[0],pt=lt*ke,_t=lt*ut,Mt=Re/(-ke+ut),rt=Mt*-ke;if(ie.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(rt),$.translateZ(Mt),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Pe[10]===-1)$.projectionMatrix.copy(ie.projectionMatrix),$.projectionMatrixInverse.copy(ie.projectionMatrixInverse);else{let dt=lt+Mt,D=Oe+Mt,It=pt-rt,Ye=_t+(Re-rt),S=Je*Oe/D*dt,f=Xe*Oe/D*dt;$.projectionMatrix.makePerspective(It,Ye,S,f,dt,D),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function pe($,ie){ie===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(ie.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(s===null)return;let ie=$.near,ee=$.far;m.texture!==null&&(m.depthNear>0&&(ie=m.depthNear),m.depthFar>0&&(ee=m.depthFar)),I.near=R.near=b.near=ie,I.far=R.far=b.far=ee,(O!==I.near||H!==I.far)&&(s.updateRenderState({depthNear:I.near,depthFar:I.far}),O=I.near,H=I.far),I.layers.mask=$.layers.mask|6,b.layers.mask=I.layers.mask&-5,R.layers.mask=I.layers.mask&-3;let Re=$.parent,Pe=I.cameras;pe(I,Re);for(let Te=0;Te<Pe.length;Te++)pe(Pe[Te],Re);Pe.length===2?he(I,b,R):I.projectionMatrix.copy(b.projectionMatrix),_e($,I,Re)};function _e($,ie,ee){ee===null?$.matrix.copy(ie.matrixWorld):($.matrix.copy(ee.matrixWorld),$.matrix.invert(),$.matrix.multiply(ie.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(ie.projectionMatrix),$.projectionMatrixInverse.copy(ie.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=tr*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return I},this.getFoveation=function(){if(!(h===null&&g===null))return c},this.setFoveation=function($){c=$,h!==null&&(h.fixedFoveation=$),g!==null&&g.fixedFoveation!==void 0&&(g.fixedFoveation=$)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(I)},this.getCameraTexture=function($){return u[$]};let He=null;function st($,ie){if(d=ie.getViewerPose(l||a),x=ie,d!==null){let ee=d.views;g!==null&&(e.setRenderTargetFramebuffer(y,g.framebuffer),e.setRenderTarget(y));let Re=!1;ee.length!==I.cameras.length&&(I.cameras.length=0,Re=!0);for(let Oe=0;Oe<ee.length;Oe++){let Je=ee[Oe],Xe=null;if(g!==null)Xe=g.getViewport(Je);else{let ut=p.getViewSubImage(h,Je);Xe=ut.viewport,Oe===0&&(e.setRenderTargetTextures(y,ut.colorTexture,ut.depthStencilTexture),e.setRenderTarget(y))}let ke=A[Oe];ke===void 0&&(ke=new At,ke.layers.enable(Oe),ke.viewport=new tt,A[Oe]=ke),ke.matrix.fromArray(Je.transform.matrix),ke.matrix.decompose(ke.position,ke.quaternion,ke.scale),ke.projectionMatrix.fromArray(Je.projectionMatrix),ke.projectionMatrixInverse.copy(ke.projectionMatrix).invert(),ke.viewport.set(Xe.x,Xe.y,Xe.width,Xe.height),Oe===0&&(I.matrix.copy(ke.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale)),Re===!0&&I.cameras.push(ke)}let Pe=s.enabledFeatures;if(Pe&&Pe.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&M){p=n.getBinding();let Oe=p.getDepthInformation(ee[0]);Oe&&Oe.isValid&&Oe.texture&&m.init(Oe,s.renderState)}if(Pe&&Pe.includes("camera-access")&&M){e.state.unbindTexture(),p=n.getBinding();for(let Oe=0;Oe<ee.length;Oe++){let Je=ee[Oe].camera;if(Je){let Xe=u[Je];Xe||(Xe=new ts,u[Je]=Xe);let ke=p.getCameraImage(Je);Xe.sourceTexture=ke}}}}for(let ee=0;ee<T.length;ee++){let Re=E[ee],Pe=T[ee];Re!==null&&Pe!==void 0&&Pe.update(Re,ie,l||a)}He&&He($,ie),ie.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ie}),x=null}let We=new Ec;We.setAnimationLoop(st),this.setAnimationLoop=function($){He=$},this.dispose=function(){}}},tm=new nt,Ic=new Ie;Ic.set(-1,0,0,0,1,0,0,0,1);function nm(i,e){function t(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function n(m,u){u.color.getRGB(m.fogColor.value,bo(i)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function s(m,u,w,P,y){u.isNodeMaterial?u.uniformsNeedUpdate=!1:u.isMeshBasicMaterial?r(m,u):u.isMeshLambertMaterial?(r(m,u),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)):u.isMeshToonMaterial?(r(m,u),p(m,u)):u.isMeshPhongMaterial?(r(m,u),d(m,u),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)):u.isMeshStandardMaterial?(r(m,u),h(m,u),u.isMeshPhysicalMaterial&&g(m,u,y)):u.isMeshMatcapMaterial?(r(m,u),x(m,u)):u.isMeshDepthMaterial?r(m,u):u.isMeshDistanceMaterial?(r(m,u),M(m,u)):u.isMeshNormalMaterial?r(m,u):u.isLineBasicMaterial?(a(m,u),u.isLineDashedMaterial&&o(m,u)):u.isPointsMaterial?c(m,u,w,P):u.isSpriteMaterial?l(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function r(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,t(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===Rt&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,t(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===Rt&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,t(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,t(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);let w=e.get(u),P=w.envMap,y=w.envMapRotation;P&&(m.envMap.value=P,m.envMapRotation.value.setFromMatrix4(tm.makeRotationFromEuler(y)).transpose(),P.isCubeTexture&&P.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Ic),m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,m.aoMapTransform))}function a(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform))}function o(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function c(m,u,w,P){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*w,m.scale.value=P*.5,u.map&&(m.map.value=u.map,t(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function l(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,t(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,t(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function d(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function p(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function h(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function g(m,u,w){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Rt&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,u){u.matcap&&(m.matcap.value=u.matcap)}function M(m,u){let w=e.get(u).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function im(i,e,t,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(y,T){let E=T.program;n.uniformBlockBinding(y,E)}function l(y,T){let E=s[y.id];E===void 0&&(m(y),E=d(y),s[y.id]=E,y.addEventListener("dispose",w));let C=T.program;n.updateUBOMapping(y,C);let _=e.render.frame;r[y.id]!==_&&(h(y),r[y.id]=_)}function d(y){let T=p();y.__bindingPointIndex=T;let E=i.createBuffer(),C=y.__size,_=y.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,C,_),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,E),E}function p(){for(let y=0;y<o;y++)if(a.indexOf(y)===-1)return a.push(y),y;return Ce("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(y){let T=s[y.id],E=y.uniforms,C=y.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let _=0,b=E.length;_<b;_++){let R=E[_];if(Array.isArray(R))for(let A=0,I=R.length;A<I;A++)g(R[A],_,A,C);else g(R,_,0,C)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function g(y,T,E,C){if(M(y,T,E,C)===!0){let _=y.__offset,b=y.value;if(Array.isArray(b)){let R=0;for(let A=0;A<b.length;A++){let I=b[A],O=u(I);x(I,y.__data,R),typeof I!="number"&&typeof I!="boolean"&&!I.isMatrix3&&!ArrayBuffer.isView(I)&&(R+=O.storage/Float32Array.BYTES_PER_ELEMENT)}}else x(b,y.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,_,y.__data)}}function x(y,T,E){typeof y=="number"||typeof y=="boolean"?T[0]=y:y.isMatrix3?(T[0]=y.elements[0],T[1]=y.elements[1],T[2]=y.elements[2],T[3]=0,T[4]=y.elements[3],T[5]=y.elements[4],T[6]=y.elements[5],T[7]=0,T[8]=y.elements[6],T[9]=y.elements[7],T[10]=y.elements[8],T[11]=0):ArrayBuffer.isView(y)?T.set(new y.constructor(y.buffer,y.byteOffset,T.length)):y.toArray(T,E)}function M(y,T,E,C){let _=y.value,b=T+"_"+E;if(C[b]===void 0)return typeof _=="number"||typeof _=="boolean"?C[b]=_:ArrayBuffer.isView(_)?C[b]=_.slice():C[b]=_.clone(),!0;{let R=C[b];if(typeof _=="number"||typeof _=="boolean"){if(R!==_)return C[b]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(R.equals(_)===!1)return R.copy(_),!0}}return!1}function m(y){let T=y.uniforms,E=0,C=16;for(let b=0,R=T.length;b<R;b++){let A=Array.isArray(T[b])?T[b]:[T[b]];for(let I=0,O=A.length;I<O;I++){let H=A[I],B=Array.isArray(H.value)?H.value:[H.value];for(let W=0,X=B.length;W<X;W++){let K=B[W],j=u(K),he=E%C,pe=he%j.boundary,_e=he+pe;E+=pe,_e!==0&&C-_e<j.storage&&(E+=C-_e),H.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),H.__offset=E,E+=j.storage}}}let _=E%C;return _>0&&(E+=C-_),y.__size=E,y.__cache={},this}function u(y){let T={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(T.boundary=4,T.storage=4):y.isVector2?(T.boundary=8,T.storage=8):y.isVector3||y.isColor?(T.boundary=16,T.storage=12):y.isVector4?(T.boundary=16,T.storage=16):y.isMatrix3?(T.boundary=48,T.storage=48):y.isMatrix4?(T.boundary=64,T.storage=64):y.isTexture?we("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(T.boundary=16,T.storage=y.byteLength):we("WebGLRenderer: Unsupported uniform value type.",y),T}function w(y){let T=y.target;T.removeEventListener("dispose",w);let E=a.indexOf(T.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(s[T.id]),delete s[T.id],delete r[T.id]}function P(){for(let y in s)i.deleteBuffer(s[y]);a=[],s={},r={}}return{bind:c,update:l,dispose:P}}var sm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),fn=null;function rm(){return fn===null&&(fn=new ar(sm,16,16,Yn,dn),fn.name="DFG_LUT",fn.minFilter=St,fn.magFilter=St,fn.wrapS=rn,fn.wrapT=rn,fn.generateMipmaps=!1,fn.needsUpdate=!0),fn}var ma=class{constructor(e={}){let{canvas:t=Jl(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:g=Dt}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=n.getContextAttributes().alpha}else x=a;let M=g,m=new Set([Pr,Ir,Rr]),u=new Set([Dt,Kt,Ni,Ui,wr,Cr]),w=new Uint32Array(4),P=new Int32Array(4),y=new F,T=null,E=null,C=[],_=[],b=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=$t,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let R=this,A=!1,I=null,O=null,H=null,B=null;this._outputColorSpace=Ot;let W=0,X=0,K=null,j=-1,he=null,pe=new tt,_e=new tt,He=null,st=new Fe(0),We=0,$=t.width,ie=t.height,ee=1,Re=null,Pe=null,Te=new tt(0,0,$,ie),lt=new tt(0,0,$,ie),Oe=!1,Je=new Ri,Xe=!1,ke=!1,ut=new nt,pt=new F,_t=new tt,Mt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},rt=!1;function dt(){return K===null?ee:1}let D=n;function It(v,N){return t.getContext(v,N)}try{let v={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:d,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"185"}`),t.addEventListener("webglcontextlost",at,!1),t.addEventListener("webglcontextrestored",Qe,!1),t.addEventListener("webglcontextcreationerror",jt,!1),D===null){let N="webgl2";if(D=It(N,v),D===null)throw It(N)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(v){throw Ce("WebGLRenderer: "+v.message),v}let Ye,S,f,U,k,q,te,se,Y,J,re,Me,le,ae,Ee,Ae,Le,L,ne,Z,oe,fe,Q;function ye(){Ye=new df(D),Ye.init(),oe=new Qp(D,Ye),S=new sf(D,Ye,e,oe),f=new $p(D,Ye),S.reversedDepthBuffer&&h&&f.buffers.depth.setReversed(!0),O=D.createFramebuffer(),H=D.createFramebuffer(),B=D.createFramebuffer(),U=new mf(D),k=new Fp,q=new Kp(D,Ye,f,k,S,oe,U),te=new uf(R),se=new xh(D),fe=new tf(D,se),Y=new ff(D,se,U,fe),J=new _f(D,Y,se,fe,U),L=new gf(D,S,q),Ee=new rf(k),re=new Up(R,te,Ye,S,fe,Ee),Me=new nm(R,k),le=new Bp,ae=new Wp(Ye),Le=new ef(R,te,f,J,x,c),Ae=new Jp(R,J,S),Q=new im(D,U,S,f),ne=new nf(D,Ye,U),Z=new pf(D,Ye,U),U.programs=re.programs,R.capabilities=S,R.extensions=Ye,R.properties=k,R.renderLists=le,R.shadowMap=Ae,R.state=f,R.info=U}ye(),M!==Dt&&(b=new vf(M,t.width,t.height,o,s,r));let xe=new ko(R,D);this.xr=xe,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){let v=Ye.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){let v=Ye.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return ee},this.setPixelRatio=function(v){v!==void 0&&(ee=v,this.setSize($,ie,!1))},this.getSize=function(v){return v.set($,ie)},this.setSize=function(v,N,G=!0){if(xe.isPresenting){we("WebGLRenderer: Can't change size while VR device is presenting.");return}$=v,ie=N,t.width=Math.floor(v*ee),t.height=Math.floor(N*ee),G===!0&&(t.style.width=v+"px",t.style.height=N+"px"),b!==null&&b.setSize(t.width,t.height),this.setViewport(0,0,v,N)},this.getDrawingBufferSize=function(v){return v.set($*ee,ie*ee).floor()},this.setDrawingBufferSize=function(v,N,G){$=v,ie=N,ee=G,t.width=Math.floor(v*G),t.height=Math.floor(N*G),this.setViewport(0,0,v,N)},this.setEffects=function(v){if(M===Dt){Ce("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let N=0;N<v.length;N++)if(v[N].isOutputPass===!0){we("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}b.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(pe)},this.getViewport=function(v){return v.copy(Te)},this.setViewport=function(v,N,G,z){v.isVector4?Te.set(v.x,v.y,v.z,v.w):Te.set(v,N,G,z),f.viewport(pe.copy(Te).multiplyScalar(ee).round())},this.getScissor=function(v){return v.copy(lt)},this.setScissor=function(v,N,G,z){v.isVector4?lt.set(v.x,v.y,v.z,v.w):lt.set(v,N,G,z),f.scissor(_e.copy(lt).multiplyScalar(ee).round())},this.getScissorTest=function(){return Oe},this.setScissorTest=function(v){f.setScissorTest(Oe=v)},this.setOpaqueSort=function(v){Re=v},this.setTransparentSort=function(v){Pe=v},this.getClearColor=function(v){return v.copy(Le.getClearColor())},this.setClearColor=function(){Le.setClearColor(...arguments)},this.getClearAlpha=function(){return Le.getClearAlpha()},this.setClearAlpha=function(){Le.setClearAlpha(...arguments)},this.clear=function(v=!0,N=!0,G=!0){let z=0;if(v){let V=!1;if(K!==null){let de=K.texture.format;V=m.has(de)}if(V){let de=K.texture.type,ge=u.has(de),ue=Le.getClearColor(),ve=Le.getClearAlpha(),Se=ue.r,De=ue.g,Ue=ue.b;ge?(w[0]=Se,w[1]=De,w[2]=Ue,w[3]=ve,D.clearBufferuiv(D.COLOR,0,w)):(P[0]=Se,P[1]=De,P[2]=Ue,P[3]=ve,D.clearBufferiv(D.COLOR,0,P))}else z|=D.COLOR_BUFFER_BIT}N&&(z|=D.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),G&&(z|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),z!==0&&D.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),I=v},this.dispose=function(){t.removeEventListener("webglcontextlost",at,!1),t.removeEventListener("webglcontextrestored",Qe,!1),t.removeEventListener("webglcontextcreationerror",jt,!1),Le.dispose(),le.dispose(),ae.dispose(),k.dispose(),te.dispose(),J.dispose(),fe.dispose(),Q.dispose(),re.dispose(),xe.dispose(),xe.removeEventListener("sessionstart",Ho),xe.removeEventListener("sessionend",Wo),Jn.stop()};function at(v){v.preventDefault(),So("WebGLRenderer: Context Lost."),A=!0}function Qe(){So("WebGLRenderer: Context Restored."),A=!1;let v=U.autoReset,N=Ae.enabled,G=Ae.autoUpdate,z=Ae.needsUpdate,V=Ae.type;ye(),U.autoReset=v,Ae.enabled=N,Ae.autoUpdate=G,Ae.needsUpdate=z,Ae.type=V}function jt(v){Ce("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function en(v){let N=v.target;N.removeEventListener("dispose",en),Pc(N)}function Pc(v){Lc(v),k.remove(v)}function Lc(v){let N=k.get(v).programs;N!==void 0&&(N.forEach(function(G){re.releaseProgram(G)}),v.isShaderMaterial&&re.releaseShaderCache(v))}this.renderBufferDirect=function(v,N,G,z,V,de){N===null&&(N=Mt);let ge=V.isMesh&&V.matrixWorld.determinantAffine()<0,ue=Uc(v,N,G,z,V);f.setMaterial(z,ge);let ve=G.index,Se=1;if(z.wireframe===!0){if(ve=Y.getWireframeAttribute(G),ve===void 0)return;Se=2}let De=G.drawRange,Ue=G.attributes.position,be=De.start*Se,Ze=(De.start+De.count)*Se;de!==null&&(be=Math.max(be,de.start*Se),Ze=Math.min(Ze,(de.start+de.count)*Se)),ve!==null?(be=Math.max(be,0),Ze=Math.min(Ze,ve.count)):Ue!=null&&(be=Math.max(be,0),Ze=Math.min(Ze,Ue.count));let ct=Ze-be;if(ct<0||ct===1/0)return;fe.setup(V,z,ue,G,ve);let ot,$e=ne;if(ve!==null&&(ot=se.get(ve),$e=Z,$e.setIndex(ot)),V.isMesh)z.wireframe===!0?(f.setLineWidth(z.wireframeLinewidth*dt()),$e.setMode(D.LINES)):$e.setMode(D.TRIANGLES);else if(V.isLine){let bt=z.linewidth;bt===void 0&&(bt=1),f.setLineWidth(bt*dt()),V.isLineSegments?$e.setMode(D.LINES):V.isLineLoop?$e.setMode(D.LINE_LOOP):$e.setMode(D.LINE_STRIP)}else V.isPoints?$e.setMode(D.POINTS):V.isSprite&&$e.setMode(D.TRIANGLES);if(V.isBatchedMesh)if(Ye.get("WEBGL_multi_draw"))$e.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{let bt=V._multiDrawStarts,me=V._multiDrawCounts,Nt=V._multiDrawCount,Ge=ve?se.get(ve).bytesPerElement:1,Gt=k.get(z).currentProgram.getUniforms();for(let tn=0;tn<Nt;tn++)Gt.setValue(D,"_gl_DrawID",tn),$e.render(bt[tn]/Ge,me[tn])}else if(V.isInstancedMesh)$e.renderInstances(be,ct,V.count);else if(G.isInstancedBufferGeometry){let bt=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,me=Math.min(G.instanceCount,bt);$e.renderInstances(be,ct,me)}else $e.render(be,ct)};function Go(v,N,G){v.transparent===!0&&v.side===hn&&v.forceSinglePass===!1?(v.side=Rt,v.needsUpdate=!0,Ms(v,N,G),v.side=Sn,v.needsUpdate=!0,Ms(v,N,G),v.side=hn):Ms(v,N,G)}this.compile=function(v,N,G=null){G===null&&(G=v),E=ae.get(G),E.init(N),_.push(E),G.traverseVisible(function(V){V.isLight&&V.layers.test(N.layers)&&(E.pushLight(V),V.castShadow&&E.pushShadow(V))}),v!==G&&v.traverseVisible(function(V){V.isLight&&V.layers.test(N.layers)&&(E.pushLight(V),V.castShadow&&E.pushShadow(V))}),E.setupLights();let z=new Set;return v.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;let de=V.material;if(de)if(Array.isArray(de))for(let ge=0;ge<de.length;ge++){let ue=de[ge];Go(ue,G,V),z.add(ue)}else Go(de,G,V),z.add(de)}),E=_.pop(),z},this.compileAsync=function(v,N,G=null){let z=this.compile(v,N,G);return new Promise(V=>{function de(){if(z.forEach(function(ge){k.get(ge).currentProgram.isReady()&&z.delete(ge)}),z.size===0){V(v);return}setTimeout(de,10)}Ye.get("KHR_parallel_shader_compile")!==null?de():setTimeout(de,10)})};let xa=null;function Dc(v){xa&&xa(v)}function Ho(){Jn.stop()}function Wo(){Jn.start()}let Jn=new Ec;Jn.setAnimationLoop(Dc),typeof self<"u"&&Jn.setContext(self),this.setAnimationLoop=function(v){xa=v,xe.setAnimationLoop(v),v===null?Jn.stop():Jn.start()},xe.addEventListener("sessionstart",Ho),xe.addEventListener("sessionend",Wo),this.render=function(v,N){if(N!==void 0&&N.isCamera!==!0){Ce("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(A===!0)return;I!==null&&I.renderStart(v,N);let G=xe.enabled===!0&&xe.isPresenting===!0,z=b!==null&&(K===null||G)&&b.begin(R,K);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),xe.enabled===!0&&xe.isPresenting===!0&&(b===null||b.isCompositing()===!1)&&(xe.cameraAutoUpdate===!0&&xe.updateCamera(N),N=xe.getCamera()),v.isScene===!0&&v.onBeforeRender(R,v,N,K),E=ae.get(v,_.length),E.init(N),E.state.textureUnits=q.getTextureUnits(),_.push(E),ut.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),Je.setFromProjectionMatrix(ut,Jt,N.reversedDepth),ke=this.localClippingEnabled,Xe=Ee.init(this.clippingPlanes,ke),T=le.get(v,C.length),T.init(),C.push(T),xe.enabled===!0&&xe.isPresenting===!0){let ge=R.xr.getDepthSensingMesh();ge!==null&&va(ge,N,-1/0,R.sortObjects)}va(v,N,0,R.sortObjects),T.finish(),R.sortObjects===!0&&T.sort(Re,Pe,N.reversedDepth),rt=xe.enabled===!1||xe.isPresenting===!1||xe.hasDepthSensing()===!1,rt&&Le.addToRenderList(T,v),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Xe===!0&&Ee.beginShadows();let V=E.state.shadowsArray;if(Ae.render(V,v,N),Xe===!0&&Ee.endShadows(),(z&&b.hasRenderPass())===!1){let ge=T.opaque,ue=T.transmissive;if(E.setupLights(),N.isArrayCamera){let ve=N.cameras;if(ue.length>0)for(let Se=0,De=ve.length;Se<De;Se++){let Ue=ve[Se];qo(ge,ue,v,Ue)}rt&&Le.render(v);for(let Se=0,De=ve.length;Se<De;Se++){let Ue=ve[Se];Xo(T,v,Ue,Ue.viewport)}}else ue.length>0&&qo(ge,ue,v,N),rt&&Le.render(v),Xo(T,v,N)}K!==null&&X===0&&(q.updateMultisampleRenderTarget(K),q.updateRenderTargetMipmap(K)),z&&b.end(R),v.isScene===!0&&v.onAfterRender(R,v,N),fe.resetDefaultState(),j=-1,he=null,_.pop(),_.length>0?(E=_[_.length-1],q.setTextureUnits(E.state.textureUnits),Xe===!0&&Ee.setGlobalState(R.clippingPlanes,E.state.camera)):E=null,C.pop(),C.length>0?T=C[C.length-1]:T=null,I!==null&&I.renderEnd()};function va(v,N,G,z){if(v.visible===!1)return;if(v.layers.test(N.layers)){if(v.isGroup)G=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(N);else if(v.isLightProbeGrid)E.pushLightProbeGrid(v);else if(v.isLight)E.pushLight(v),v.castShadow&&E.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||Je.intersectsSprite(v)){z&&_t.setFromMatrixPosition(v.matrixWorld).applyMatrix4(ut);let ge=J.update(v),ue=v.material;ue.visible&&T.push(v,ge,ue,G,_t.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||Je.intersectsObject(v))){let ge=J.update(v),ue=v.material;if(z&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),_t.copy(v.boundingSphere.center)):(ge.boundingSphere===null&&ge.computeBoundingSphere(),_t.copy(ge.boundingSphere.center)),_t.applyMatrix4(v.matrixWorld).applyMatrix4(ut)),Array.isArray(ue)){let ve=ge.groups;for(let Se=0,De=ve.length;Se<De;Se++){let Ue=ve[Se],be=ue[Ue.materialIndex];be&&be.visible&&T.push(v,ge,be,G,_t.z,Ue)}}else ue.visible&&T.push(v,ge,ue,G,_t.z,null)}}let de=v.children;for(let ge=0,ue=de.length;ge<ue;ge++)va(de[ge],N,G,z)}function Xo(v,N,G,z){let{opaque:V,transmissive:de,transparent:ge}=v;E.setupLightsView(G),Xe===!0&&Ee.setGlobalState(R.clippingPlanes,G),z&&f.viewport(pe.copy(z)),V.length>0&&ys(V,N,G),de.length>0&&ys(de,N,G),ge.length>0&&ys(ge,N,G),f.buffers.depth.setTest(!0),f.buffers.depth.setMask(!0),f.buffers.color.setMask(!0),f.setPolygonOffset(!1)}function qo(v,N,G,z){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;if(E.state.transmissionRenderTarget[z.id]===void 0){let be=Ye.has("EXT_color_buffer_half_float")||Ye.has("EXT_color_buffer_float");E.state.transmissionRenderTarget[z.id]=new zt(1,1,{generateMipmaps:!0,type:be?dn:Dt,minFilter:Xn,samples:Math.max(4,S.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Be.workingColorSpace})}let de=E.state.transmissionRenderTarget[z.id],ge=z.viewport||pe;de.setSize(ge.z*R.transmissionResolutionScale,ge.w*R.transmissionResolutionScale);let ue=R.getRenderTarget(),ve=R.getActiveCubeFace(),Se=R.getActiveMipmapLevel();R.setRenderTarget(de),R.getClearColor(st),We=R.getClearAlpha(),We<1&&R.setClearColor(16777215,.5),R.clear(),rt&&Le.render(G);let De=R.toneMapping;R.toneMapping=$t;let Ue=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),E.setupLightsView(z),Xe===!0&&Ee.setGlobalState(R.clippingPlanes,z),ys(v,G,z),q.updateMultisampleRenderTarget(de),q.updateRenderTargetMipmap(de),Ye.has("WEBGL_multisampled_render_to_texture")===!1){let be=!1;for(let Ze=0,ct=N.length;Ze<ct;Ze++){let ot=N[Ze],{object:$e,geometry:bt,material:me,group:Nt}=ot;if(me.side===hn&&$e.layers.test(z.layers)){let Ge=me.side;me.side=Rt,me.needsUpdate=!0,Yo($e,G,z,bt,me,Nt),me.side=Ge,me.needsUpdate=!0,be=!0}}be===!0&&(q.updateMultisampleRenderTarget(de),q.updateRenderTargetMipmap(de))}R.setRenderTarget(ue,ve,Se),R.setClearColor(st,We),Ue!==void 0&&(z.viewport=Ue),R.toneMapping=De}function ys(v,N,G){let z=N.isScene===!0?N.overrideMaterial:null;for(let V=0,de=v.length;V<de;V++){let ge=v[V],{object:ue,geometry:ve,group:Se}=ge,De=ge.material;De.allowOverride===!0&&z!==null&&(De=z),ue.layers.test(G.layers)&&Yo(ue,N,G,ve,De,Se)}}function Yo(v,N,G,z,V,de){v.onBeforeRender(R,N,G,z,V,de),v.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),V.onBeforeRender(R,N,G,z,v,de),V.transparent===!0&&V.side===hn&&V.forceSinglePass===!1?(V.side=Rt,V.needsUpdate=!0,R.renderBufferDirect(G,N,z,V,v,de),V.side=Sn,V.needsUpdate=!0,R.renderBufferDirect(G,N,z,V,v,de),V.side=hn):R.renderBufferDirect(G,N,z,V,v,de),v.onAfterRender(R,N,G,z,V,de)}function Ms(v,N,G){N.isScene!==!0&&(N=Mt);let z=k.get(v),V=E.state.lights,de=E.state.shadowsArray,ge=V.state.version,ue=re.getParameters(v,V.state,de,N,G,E.state.lightProbeGridArray),ve=re.getProgramCacheKey(ue),Se=z.programs;z.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?N.environment:null,z.fog=N.fog;let De=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;z.envMap=te.get(v.envMap||z.environment,De),z.envMapRotation=z.environment!==null&&v.envMap===null?N.environmentRotation:v.envMapRotation,Se===void 0&&(v.addEventListener("dispose",en),Se=new Map,z.programs=Se);let Ue=Se.get(ve);if(Ue!==void 0){if(z.currentProgram===Ue&&z.lightsStateVersion===ge)return Jo(v,ue),Ue}else ue.uniforms=re.getUniforms(v),I!==null&&v.isNodeMaterial&&I.build(v,G,ue),v.onBeforeCompile(ue,R),Ue=re.acquireProgram(ue,ve),Se.set(ve,Ue),z.uniforms=ue.uniforms;let be=z.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(be.clippingPlanes=Ee.uniform),Jo(v,ue),z.needsLights=Oc(v),z.lightsStateVersion=ge,z.needsLights&&(be.ambientLightColor.value=V.state.ambient,be.lightProbe.value=V.state.probe,be.directionalLights.value=V.state.directional,be.directionalLightShadows.value=V.state.directionalShadow,be.spotLights.value=V.state.spot,be.spotLightShadows.value=V.state.spotShadow,be.rectAreaLights.value=V.state.rectArea,be.ltc_1.value=V.state.rectAreaLTC1,be.ltc_2.value=V.state.rectAreaLTC2,be.pointLights.value=V.state.point,be.pointLightShadows.value=V.state.pointShadow,be.hemisphereLights.value=V.state.hemi,be.directionalShadowMatrix.value=V.state.directionalShadowMatrix,be.spotLightMatrix.value=V.state.spotLightMatrix,be.spotLightMap.value=V.state.spotLightMap,be.pointShadowMatrix.value=V.state.pointShadowMatrix),z.lightProbeGrid=E.state.lightProbeGridArray.length>0,z.currentProgram=Ue,z.uniformsList=null,Ue}function Zo(v){if(v.uniformsList===null){let N=v.currentProgram.getUniforms();v.uniformsList=Oi.seqWithValue(N.seq,v.uniforms)}return v.uniformsList}function Jo(v,N){let G=k.get(v);G.outputColorSpace=N.outputColorSpace,G.batching=N.batching,G.batchingColor=N.batchingColor,G.instancing=N.instancing,G.instancingColor=N.instancingColor,G.instancingMorph=N.instancingMorph,G.skinning=N.skinning,G.morphTargets=N.morphTargets,G.morphNormals=N.morphNormals,G.morphColors=N.morphColors,G.morphTargetsCount=N.morphTargetsCount,G.numClippingPlanes=N.numClippingPlanes,G.numIntersection=N.numClipIntersection,G.vertexAlphas=N.vertexAlphas,G.vertexTangents=N.vertexTangents,G.toneMapping=N.toneMapping}function Nc(v,N){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;y.setFromMatrixPosition(N.matrixWorld);for(let G=0,z=v.length;G<z;G++){let V=v[G];if(V.texture!==null&&V.boundingBox.containsPoint(y))return V}return null}function Uc(v,N,G,z,V){N.isScene!==!0&&(N=Mt),q.resetTextureUnits();let de=N.fog,ge=z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial?N.environment:null,ue=K===null?R.outputColorSpace:K.isXRRenderTarget===!0?K.texture.colorSpace:Be.workingColorSpace,ve=z.isMeshStandardMaterial||z.isMeshLambertMaterial&&!z.envMap||z.isMeshPhongMaterial&&!z.envMap,Se=te.get(z.envMap||ge,ve),De=z.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,Ue=!!G.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),be=!!G.morphAttributes.position,Ze=!!G.morphAttributes.normal,ct=!!G.morphAttributes.color,ot=$t;z.toneMapped&&(K===null||K.isXRRenderTarget===!0)&&(ot=R.toneMapping);let $e=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,bt=$e!==void 0?$e.length:0,me=k.get(z),Nt=E.state.lights;if(Xe===!0&&(ke===!0||v!==he)){let je=v===he&&z.id===j;Ee.setState(z,v,je)}let Ge=!1;z.version===me.__version?(me.needsLights&&me.lightsStateVersion!==Nt.state.version||me.outputColorSpace!==ue||V.isBatchedMesh&&me.batching===!1||!V.isBatchedMesh&&me.batching===!0||V.isBatchedMesh&&me.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&me.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&me.instancing===!1||!V.isInstancedMesh&&me.instancing===!0||V.isSkinnedMesh&&me.skinning===!1||!V.isSkinnedMesh&&me.skinning===!0||V.isInstancedMesh&&me.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&me.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&me.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&me.instancingMorph===!1&&V.morphTexture!==null||me.envMap!==Se||z.fog===!0&&me.fog!==de||me.numClippingPlanes!==void 0&&(me.numClippingPlanes!==Ee.numPlanes||me.numIntersection!==Ee.numIntersection)||me.vertexAlphas!==De||me.vertexTangents!==Ue||me.morphTargets!==be||me.morphNormals!==Ze||me.morphColors!==ct||me.toneMapping!==ot||me.morphTargetsCount!==bt||!!me.lightProbeGrid!=E.state.lightProbeGridArray.length>0)&&(Ge=!0):(Ge=!0,me.__version=z.version);let Gt=me.currentProgram;Ge===!0&&(Gt=Ms(z,N,V),I&&z.isNodeMaterial&&I.onUpdateProgram(z,Gt,me));let tn=!1,An=!1,ci=!1,Ke=Gt.getUniforms(),ht=me.uniforms;if(f.useProgram(Gt.program)&&(tn=!0,An=!0,ci=!0),z.id!==j&&(j=z.id,An=!0),me.needsLights){let je=Nc(E.state.lightProbeGridArray,V);me.lightProbeGrid!==je&&(me.lightProbeGrid=je,An=!0)}if(tn||he!==v){f.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),Ke.setValue(D,"projectionMatrix",v.projectionMatrix),Ke.setValue(D,"viewMatrix",v.matrixWorldInverse);let Cn=Ke.map.cameraPosition;Cn!==void 0&&Cn.setValue(D,pt.setFromMatrixPosition(v.matrixWorld)),S.logarithmicDepthBuffer&&Ke.setValue(D,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&Ke.setValue(D,"isOrthographic",v.isOrthographicCamera===!0),he!==v&&(he=v,An=!0,ci=!0)}if(me.needsLights&&(Nt.state.directionalShadowMap.length>0&&Ke.setValue(D,"directionalShadowMap",Nt.state.directionalShadowMap,q),Nt.state.spotShadowMap.length>0&&Ke.setValue(D,"spotShadowMap",Nt.state.spotShadowMap,q),Nt.state.pointShadowMap.length>0&&Ke.setValue(D,"pointShadowMap",Nt.state.pointShadowMap,q)),V.isSkinnedMesh){Ke.setOptional(D,V,"bindMatrix"),Ke.setOptional(D,V,"bindMatrixInverse");let je=V.skeleton;je&&(je.boneTexture===null&&je.computeBoneTexture(),Ke.setValue(D,"boneTexture",je.boneTexture,q))}V.isBatchedMesh&&(Ke.setOptional(D,V,"batchingTexture"),Ke.setValue(D,"batchingTexture",V._matricesTexture,q),Ke.setOptional(D,V,"batchingIdTexture"),Ke.setValue(D,"batchingIdTexture",V._indirectTexture,q),Ke.setOptional(D,V,"batchingColorTexture"),V._colorsTexture!==null&&Ke.setValue(D,"batchingColorTexture",V._colorsTexture,q));let wn=G.morphAttributes;if((wn.position!==void 0||wn.normal!==void 0||wn.color!==void 0)&&L.update(V,G,Gt),(An||me.receiveShadow!==V.receiveShadow)&&(me.receiveShadow=V.receiveShadow,Ke.setValue(D,"receiveShadow",V.receiveShadow)),(z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial)&&z.envMap===null&&N.environment!==null&&(ht.envMapIntensity.value=N.environmentIntensity),ht.dfgLUT!==void 0&&(ht.dfgLUT.value=rm()),An){if(Ke.setValue(D,"toneMappingExposure",R.toneMappingExposure),me.needsLights&&Fc(ht,ci),de&&z.fog===!0&&Me.refreshFogUniforms(ht,de),Me.refreshMaterialUniforms(ht,z,ee,ie,E.state.transmissionRenderTarget[v.id]),me.needsLights&&me.lightProbeGrid){let je=me.lightProbeGrid;ht.probesSH.value=je.texture,ht.probesMin.value.copy(je.boundingBox.min),ht.probesMax.value.copy(je.boundingBox.max),ht.probesResolution.value.copy(je.resolution)}Oi.upload(D,Zo(me),ht,q)}if(z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(Oi.upload(D,Zo(me),ht,q),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&Ke.setValue(D,"center",V.center),Ke.setValue(D,"modelViewMatrix",V.modelViewMatrix),Ke.setValue(D,"normalMatrix",V.normalMatrix),Ke.setValue(D,"modelMatrix",V.matrixWorld),z.uniformsGroups!==void 0){let je=z.uniformsGroups;for(let Cn=0,hi=je.length;Cn<hi;Cn++){let $o=je[Cn];Q.update($o,Gt),Q.bind($o,Gt)}}return Gt}function Fc(v,N){v.ambientLightColor.needsUpdate=N,v.lightProbe.needsUpdate=N,v.directionalLights.needsUpdate=N,v.directionalLightShadows.needsUpdate=N,v.pointLights.needsUpdate=N,v.pointLightShadows.needsUpdate=N,v.spotLights.needsUpdate=N,v.spotLightShadows.needsUpdate=N,v.rectAreaLights.needsUpdate=N,v.hemisphereLights.needsUpdate=N}function Oc(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return W},this.getActiveMipmapLevel=function(){return X},this.getRenderTarget=function(){return K},this.setRenderTargetTextures=function(v,N,G){let z=k.get(v);z.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,z.__autoAllocateDepthBuffer===!1&&(z.__useRenderToTexture=!1),k.get(v.texture).__webglTexture=N,k.get(v.depthTexture).__webglTexture=z.__autoAllocateDepthBuffer?void 0:G,z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,N){let G=k.get(v);G.__webglFramebuffer=N,G.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(v,N=0,G=0){K=v,W=N,X=G;let z=null,V=!1,de=!1;if(v){let ue=k.get(v);if(ue.__useDefaultFramebuffer!==void 0){f.bindFramebuffer(D.FRAMEBUFFER,ue.__webglFramebuffer),pe.copy(v.viewport),_e.copy(v.scissor),He=v.scissorTest,f.viewport(pe),f.scissor(_e),f.setScissorTest(He),j=-1;return}else if(ue.__webglFramebuffer===void 0)q.setupRenderTarget(v);else if(ue.__hasExternalTextures)q.rebindTextures(v,k.get(v.texture).__webglTexture,k.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){let De=v.depthTexture;if(ue.__boundDepthTexture!==De){if(De!==null&&k.has(De)&&(v.width!==De.image.width||v.height!==De.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");q.setupDepthRenderbuffer(v)}}let ve=v.texture;(ve.isData3DTexture||ve.isDataArrayTexture||ve.isCompressedArrayTexture)&&(de=!0);let Se=k.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Se[N])?z=Se[N][G]:z=Se[N],V=!0):v.samples>0&&q.useMultisampledRTT(v)===!1?z=k.get(v).__webglMultisampledFramebuffer:Array.isArray(Se)?z=Se[G]:z=Se,pe.copy(v.viewport),_e.copy(v.scissor),He=v.scissorTest}else pe.copy(Te).multiplyScalar(ee).floor(),_e.copy(lt).multiplyScalar(ee).floor(),He=Oe;if(G!==0&&(z=O),f.bindFramebuffer(D.FRAMEBUFFER,z)&&f.drawBuffers(v,z),f.viewport(pe),f.scissor(_e),f.setScissorTest(He),V){let ue=k.get(v.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+N,ue.__webglTexture,G)}else if(de){let ue=N;for(let ve=0;ve<v.textures.length;ve++){let Se=k.get(v.textures[ve]);D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0+ve,Se.__webglTexture,G,ue)}}else if(v!==null&&G!==0){let ue=k.get(v.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ue.__webglTexture,G)}j=-1},this.readRenderTargetPixels=function(v,N,G,z,V,de,ge,ue=0){if(!(v&&v.isWebGLRenderTarget)){Ce("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ve=k.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ge!==void 0&&(ve=ve[ge]),ve){f.bindFramebuffer(D.FRAMEBUFFER,ve);try{let Se=v.textures[ue],De=Se.format,Ue=Se.type;if(v.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ue),!S.textureFormatReadable(De)){Ce("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!S.textureTypeReadable(Ue)){Ce("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=v.width-z&&G>=0&&G<=v.height-V&&D.readPixels(N,G,z,V,oe.convert(De),oe.convert(Ue),de)}finally{let Se=K!==null?k.get(K).__webglFramebuffer:null;f.bindFramebuffer(D.FRAMEBUFFER,Se)}}},this.readRenderTargetPixelsAsync=async function(v,N,G,z,V,de,ge,ue=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ve=k.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ge!==void 0&&(ve=ve[ge]),ve)if(N>=0&&N<=v.width-z&&G>=0&&G<=v.height-V){f.bindFramebuffer(D.FRAMEBUFFER,ve);let Se=v.textures[ue],De=Se.format,Ue=Se.type;if(v.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+ue),!S.textureFormatReadable(De))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!S.textureTypeReadable(Ue))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let be=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,be),D.bufferData(D.PIXEL_PACK_BUFFER,de.byteLength,D.STREAM_READ),D.readPixels(N,G,z,V,oe.convert(De),oe.convert(Ue),0);let Ze=K!==null?k.get(K).__webglFramebuffer:null;f.bindFramebuffer(D.FRAMEBUFFER,Ze);let ct=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await Kl(D,ct,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,be),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,de),D.deleteBuffer(be),D.deleteSync(ct),de}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,N=null,G=0){let z=Math.pow(2,-G),V=Math.floor(v.image.width*z),de=Math.floor(v.image.height*z),ge=N!==null?N.x:0,ue=N!==null?N.y:0;q.setTexture2D(v,0),D.copyTexSubImage2D(D.TEXTURE_2D,G,0,0,ge,ue,V,de),f.unbindTexture()},this.copyTextureToTexture=function(v,N,G=null,z=null,V=0,de=0){let ge,ue,ve,Se,De,Ue,be,Ze,ct,ot=v.isCompressedTexture?v.mipmaps[de]:v.image;if(G!==null)ge=G.max.x-G.min.x,ue=G.max.y-G.min.y,ve=G.isBox3?G.max.z-G.min.z:1,Se=G.min.x,De=G.min.y,Ue=G.isBox3?G.min.z:0;else{let ht=Math.pow(2,-V);ge=Math.floor(ot.width*ht),ue=Math.floor(ot.height*ht),v.isDataArrayTexture?ve=ot.depth:v.isData3DTexture?ve=Math.floor(ot.depth*ht):ve=1,Se=0,De=0,Ue=0}z!==null?(be=z.x,Ze=z.y,ct=z.z):(be=0,Ze=0,ct=0);let $e=oe.convert(N.format),bt=oe.convert(N.type),me;N.isData3DTexture?(q.setTexture3D(N,0),me=D.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(q.setTexture2DArray(N,0),me=D.TEXTURE_2D_ARRAY):(q.setTexture2D(N,0),me=D.TEXTURE_2D),f.activeTexture(D.TEXTURE0),f.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,N.flipY),f.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),f.pixelStorei(D.UNPACK_ALIGNMENT,N.unpackAlignment);let Nt=f.getParameter(D.UNPACK_ROW_LENGTH),Ge=f.getParameter(D.UNPACK_IMAGE_HEIGHT),Gt=f.getParameter(D.UNPACK_SKIP_PIXELS),tn=f.getParameter(D.UNPACK_SKIP_ROWS),An=f.getParameter(D.UNPACK_SKIP_IMAGES);f.pixelStorei(D.UNPACK_ROW_LENGTH,ot.width),f.pixelStorei(D.UNPACK_IMAGE_HEIGHT,ot.height),f.pixelStorei(D.UNPACK_SKIP_PIXELS,Se),f.pixelStorei(D.UNPACK_SKIP_ROWS,De),f.pixelStorei(D.UNPACK_SKIP_IMAGES,Ue);let ci=v.isDataArrayTexture||v.isData3DTexture,Ke=N.isDataArrayTexture||N.isData3DTexture;if(v.isDepthTexture){let ht=k.get(v),wn=k.get(N),je=k.get(ht.__renderTarget),Cn=k.get(wn.__renderTarget);f.bindFramebuffer(D.READ_FRAMEBUFFER,je.__webglFramebuffer),f.bindFramebuffer(D.DRAW_FRAMEBUFFER,Cn.__webglFramebuffer);for(let hi=0;hi<ve;hi++)ci&&(D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,k.get(v).__webglTexture,V,Ue+hi),D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,k.get(N).__webglTexture,de,ct+hi)),D.blitFramebuffer(Se,De,ge,ue,be,Ze,ge,ue,D.DEPTH_BUFFER_BIT,D.NEAREST);f.bindFramebuffer(D.READ_FRAMEBUFFER,null),f.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else if(V!==0||v.isRenderTargetTexture||k.has(v)){let ht=k.get(v),wn=k.get(N);f.bindFramebuffer(D.READ_FRAMEBUFFER,H),f.bindFramebuffer(D.DRAW_FRAMEBUFFER,B);for(let je=0;je<ve;je++)ci?D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,ht.__webglTexture,V,Ue+je):D.framebufferTexture2D(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ht.__webglTexture,V),Ke?D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,wn.__webglTexture,de,ct+je):D.framebufferTexture2D(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,wn.__webglTexture,de),V!==0?D.blitFramebuffer(Se,De,ge,ue,be,Ze,ge,ue,D.COLOR_BUFFER_BIT,D.NEAREST):Ke?D.copyTexSubImage3D(me,de,be,Ze,ct+je,Se,De,ge,ue):D.copyTexSubImage2D(me,de,be,Ze,Se,De,ge,ue);f.bindFramebuffer(D.READ_FRAMEBUFFER,null),f.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else Ke?v.isDataTexture||v.isData3DTexture?D.texSubImage3D(me,de,be,Ze,ct,ge,ue,ve,$e,bt,ot.data):N.isCompressedArrayTexture?D.compressedTexSubImage3D(me,de,be,Ze,ct,ge,ue,ve,$e,ot.data):D.texSubImage3D(me,de,be,Ze,ct,ge,ue,ve,$e,bt,ot):v.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,de,be,Ze,ge,ue,$e,bt,ot.data):v.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,de,be,Ze,ot.width,ot.height,$e,ot.data):D.texSubImage2D(D.TEXTURE_2D,de,be,Ze,ge,ue,$e,bt,ot);f.pixelStorei(D.UNPACK_ROW_LENGTH,Nt),f.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Ge),f.pixelStorei(D.UNPACK_SKIP_PIXELS,Gt),f.pixelStorei(D.UNPACK_SKIP_ROWS,tn),f.pixelStorei(D.UNPACK_SKIP_IMAGES,An),de===0&&N.generateMipmaps&&D.generateMipmap(me),f.unbindTexture()},this.initRenderTarget=function(v){k.get(v).__webglFramebuffer===void 0&&q.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?q.setTextureCube(v,0):v.isData3DTexture?q.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?q.setTexture2DArray(v,0):q.setTexture2D(v,0),f.unbindTexture()},this.resetState=function(){W=0,X=0,K=null,f.reset(),fe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Jt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Be._getDrawingBufferColorSpace(e),t.unpackColorSpace=Be._getUnpackColorSpace()}};var om=i=>typeof i=="object"&&i!==null&&i.kind==="sky-strike";function lm(i){let e=new yn,t=new Vn({color:i,metalness:.55,roughness:.35}),n=new Vn({color:1120295,metalness:.5,roughness:.25}),s=new it(new Ii(.45,.75,5.6,10),t);s.rotation.x=Math.PI/2,e.add(s);let r=new it(new Pi(.45,1.5,10),t);r.rotation.x=-Math.PI/2,r.position.z=3.5,e.add(r);let a=new it(new cn(5.8,.12,1.15),t);a.position.z=-.3,e.add(a);let o=new it(new cn(2.6,.1,.7),t);o.position.z=-2.25,e.add(o);let c=new it(new cn(.12,1.35,.9),t);c.position.set(0,.65,-2.25),e.add(c);let l=new it(new ri(.55,12,8,0,Math.PI*2,0,Math.PI/2),n);return l.scale.set(1,.75,1.4),l.position.set(0,.5,.75),e.add(l),e}var H_=(i,e)=>{i.replaceChildren();let t=document.createElement("section");t.style.cssText="position:relative;width:100%;height:100%;min-height:320px;overflow:hidden;background:#4da3df";let n=document.createElement("canvas"),s=document.createElement("div");n.style.cssText="width:100%;height:100%;display:block",s.style.cssText="position:absolute;inset:0;pointer-events:none;color:#eefcff;font:900 14px system-ui;text-shadow:0 2px 5px #001;padding:12px;display:grid;grid-template-rows:auto 1fr auto";let r=document.createElement("div"),a=document.createElement("div"),o=document.createElement("div");a.style.cssText="display:grid;place-items:center",o.style.cssText="display:flex;justify-content:space-between;align-items:end",s.append(r,a,o),t.append(n,s),i.append(t);let c=new ma({canvas:n,antialias:!0,powerPreference:"high-performance"});c.setPixelRatio(Math.min(devicePixelRatio||1,2)),c.setClearColor(6928360);let l=new Ki;l.fog=new $i(9556463,180,520);let d=new At(68,1,.1,900);l.add(new ss(16777215,2640472,2.3));let p=new as(16777215,2.1);p.position.set(80,140,-70),l.add(p);let h=new it(new si(1100,1100),new Vn({color:1730704,roughness:.8,metalness:.08}));h.rotation.x=-Math.PI/2,h.position.y=0,l.add(h);let g=new Vn({color:6650683,roughness:1});for(let R=0;R<18;R++){let A=R*1.93,I=70+R%6*42,O=7+R%4*6,H=new it(new Pi(12+R%3*6,O,7),g);H.position.set(Math.cos(A)*I,O/2,Math.sin(A)*I),l.add(H)}let x=new zn({color:16777215,transparent:!0,opacity:.45});for(let R=0;R<20;R++){let A=new it(new ri(7+R%4*2,8,6),x);A.scale.set(2,.55,1),A.position.set(Math.sin(R*2.7)*230,70+R%5*14,Math.cos(R*1.8)*230),l.add(A)}let M=new Map,m=new Map,u=null,w=[3003583,6333946,16096779,12616956],P=e.subscribe(R=>{if(!om(R.state))return;u=R.state;let A=0;for(let I of u.planes){let O=M.get(I.id);O||(O=lm(I.bot?14239302:w[A++%w.length]??16777215),M.set(I.id,O),l.add(O)),O.visible=I.respawnMs<=0,O.position.set(I.x,I.y,I.z),O.rotation.order="YXZ",O.rotation.y=I.heading,O.rotation.x=-I.pitch,O.rotation.z=-I.roll}for(let[I,O]of M)u.planes.some(H=>H.id===I)||(l.remove(O),M.delete(I));for(let I of u.shots){let O=m.get(I.id);O||(O=new it(new ri(I.kind==="missile"?.35:.13,8,6),new zn({color:I.kind==="missile"?16733744:16774026})),m.set(I.id,O),l.add(O)),O.position.set(I.x,I.y,I.z)}for(let[I,O]of m)u.shots.some(H=>H.id===I)||(l.remove(O),m.delete(I))}),y=0,T=0,E=0,C=()=>{let R=Math.max(2,Math.round(t.clientWidth)),A=Math.max(2,Math.round(t.clientHeight));R===T&&A===E||(T=R,E=A,c.setSize(R,A,!1),d.aspect=R/A,d.updateProjectionMatrix())},_=new ResizeObserver(C);_.observe(t),C();let b=()=>{if(y=requestAnimationFrame(b),u){let R=u.planes.filter(I=>!I.bot),A=u.planes.find(I=>I.id===e.playerId&&!I.bot)??R[0]??u.planes[0];if(A&&A.respawnMs<=0){let I={x:Math.sin(A.heading)*Math.cos(A.pitch),y:Math.sin(A.pitch),z:Math.cos(A.heading)*Math.cos(A.pitch)},O={x:Math.cos(A.heading),z:-Math.sin(A.heading)},H=e.mode==="handheld"?13:19;d.position.lerp(new F(A.x-I.x*H+O.x*A.roll*2,A.y+5-I.y*5,A.z-I.z*H+O.z*A.roll*2),.13),d.lookAt(A.x+I.x*12,A.y+I.y*10,A.z+I.z*12);let B=u.planes.find(W=>W.id===A.lockId);r.textContent=`SKY STRIKE \xB7 ROUND ${u.round} \xB7 KILLS ${A.kills} \xB7 HP ${Math.round(A.hp)}%`,a.innerHTML=B?'<div style="width:58px;height:58px;border:3px solid #ff4747;border-radius:50%;display:grid;place-items:center">LOCK</div>':'<div style="width:42px;height:42px;border:2px solid #fff8;border-radius:50%"></div>',o.innerHTML=`<strong>${Math.round(A.speed*3.6)} km/h</strong><strong>ALT ${Math.round(A.y)} m</strong>`}u.phase==="round-over"&&(a.innerHTML='<strong style="font-size:clamp(30px,8vw,72px)">ROUND OVER</strong>')}c.render(l,d)};return b(),()=>{cancelAnimationFrame(y),_.disconnect(),P(),c.dispose(),l.traverse(R=>{let A=R;A.geometry?.dispose?.();let I=A.material;Array.isArray(I)?I.forEach(O=>{O.dispose()}):I?.dispose?.()}),i.replaceChildren()}};export{H_ as mountDisplay};
