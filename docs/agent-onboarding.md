...
- `releases/game-cdn/catalog.json` — publication output plus host release policy; use `game.release_status` for status changes instead of hand-editing;
- versioned `releases/game-cdn/games/*` files — immutable publication bytes;
